  ...
  for (uint64_t i = 0; i < s1; i++) {
    for (uint64_t j = 0; j < s2; j++) {
      Arr2DIdxRowM(outArr, s1, s2, i, j) = Arr2DIdxRowM(
          inArr, inps1, inps2, (Arr1DIdxRowM(beginIdx, perDimSize, 0) + i),
          (Arr1DIdxRowM(beginIdx, perDimSize, 1) + j));
    }
  }
}
        ...
        for (uint64_t l = 0; l < s4; l++) {
          for (uint64_t m = 0; m < s5; m++) {
            Arr5DIdxRowM(outArr, s1, s2, s3, s4, s5, i, j, k, l, m) =
                Arr5DIdxRowM(inArr, inps1, inps2, inps3, inps4, inps5,
                             (Arr1DIdxRowM(beginIdx, perDimSize, 0) + i),
                             (Arr1DIdxRowM(beginIdx, perDimSize, 1) + j),
                             (Arr1DIdxRowM(beginIdx, perDimSize, 2) + k),
                             (Arr1DIdxRowM(beginIdx, perDimSize, 3) + l),
                             (Arr1DIdxRowM(beginIdx, perDimSize, 4) + m));
          }
        }
      }
    }
...
void Split44(int64_t O1, int64_t O2, int64_t O3, int64_t O4, int64_t I1,
  ...
  for (uint64_t o1 = 0; o1 < O1; o1++) {
    for (uint64_t o2 = 0; o2 < O2; o2++) {
      for (uint64_t o3 = 0; o3 < O3; o3++) {
        for (uint64_t o4 = 0; o4 < O4; o4++) {
          int64_t i1 = o1;
      ...
      for (uint64_t k = 0; k < s3; k++) {
        for (uint64_t l = 0; l < s4; l++) {
          if (((((((((i >= lbounds1) && (i < rbounds1excl)) &&
            ...
            Arr4DIdxRowM(outArr, s1, s2, s3, s4, i, j, k, l) = funcSSCons(0);
          }
        }
      }
    }
      ...
      for (uint64_t k = 0; k < o3; k++) {
        for (uint64_t l = 0; l < o4; l++) {
          if (((((((((i >= lbounds1) && (i < rbounds1excl)) &&
            ...
            Arr4DIdxRowM(outArr, o1, o2, o3, o4, i, j, k, l) = funcSSCons(0);
          }
        }
      }
    }
...
void FusedBatchNorm4411(int64_t s1, int64_t s2, int64_t s3, int64_t s4,
  ...
  if (gemini::IsTwoPower(prime_mod)) {
    int nCRT = (bitlength * 2 + 1 + 40 + 49) / 50;
    int64_t n_ct_coeff_packing  = ((s2 * s3 + 4095) / 4096) * s4;
    int64_t n_ct_bfv_packing  = ((s2 * s3 * s4 + 4095) / 4096) * nCRT;
...
void FusedBN(int32_t N, int32_t H, int32_t W, int32_t CI, int32_t fh,
  ...
  Conv2DWrapper_seperate(N, H, W, CI, fh, fw, CO, padHLeft, padHRight, padWLeft, padWRight, strideH, strideW, in_tensor, scaled_filters, out_tensor);
...
int main(int argc, char **argv) {
  ...
  uint64_t *tmp6 = make_array<uint64_t>(64);
  ...
  uint64_t *tmp7 = make_array<uint64_t>(64);
  ...
  uint64_t *tmp10 = make_array<uint64_t>(1, 1, 64, 128);
  ...
  uint64_t *tmp11 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp12 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp13 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp14 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp15 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp16 = make_array<uint64_t>(96);
  ...
  uint64_t *tmp17 = make_array<uint64_t>(96);
  ...
  uint64_t *tmp18 = make_array<uint64_t>(96);
  ...
  uint64_t *tmp19 = make_array<uint64_t>(96);
  ...
  uint64_t *tmp20 = make_array<uint64_t>(1, 1, 96, 128);
  ...
  uint64_t *tmp21 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp22 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp23 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp24 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp25 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp26 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp27 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp28 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp29 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp30 = make_array<uint64_t>(1, 1, 128, 128);
  ...
  uint64_t *tmp31 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp32 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp33 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp34 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp35 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp36 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp37 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp38 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp39 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp40 = make_array<uint64_t>(1, 1, 160, 128);
  ...
  uint64_t *tmp41 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp42 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp43 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp44 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp45 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp46 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp47 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp48 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp49 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp50 = make_array<uint64_t>(1, 1, 192, 128);
  ...
  uint64_t *tmp51 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp52 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp53 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp55 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp56 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp57 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp58 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp59 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp60 = make_array<uint64_t>(1, 1, 224, 128);
  ...
  uint64_t *tmp63 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp64 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp65 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp66 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp67 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp68 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp69 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp70 = make_array<uint64_t>(1, 1, 256, 128);
  ...
  uint64_t *tmp73 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp75 = make_array<uint64_t>(1, 1, 128, 128);
  ...
  uint64_t *tmp78 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp79 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp80 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp81 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp82 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp83 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp84 = make_array<uint64_t>(160);
  ...
  uint64_t *tmp85 = make_array<uint64_t>(1, 1, 160, 128);
  ...
  uint64_t *tmp88 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp90 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp91 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp92 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp93 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp94 = make_array<uint64_t>(192);
  ...
  uint64_t *tmp95 = make_array<uint64_t>(1, 1, 192, 128);
  ...
  uint64_t *tmp96 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp97 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp98 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp100 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp101 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp102 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp103 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp104 = make_array<uint64_t>(224);
  ...
  uint64_t *tmp105 = make_array<uint64_t>(1, 1, 224, 128);
  ...
  uint64_t *tmp108 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp109 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp110 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp111 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp112 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp113 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp114 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp115 = make_array<uint64_t>(1, 1, 256, 128);
  ...
  uint64_t *tmp116 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp117 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp118 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp119 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp120 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp121 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp122 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp123 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp124 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp125 = make_array<uint64_t>(1, 1, 288, 128);
  ...
  uint64_t *tmp126 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp127 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp128 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp129 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp130 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp131 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp132 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp133 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp134 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp135 = make_array<uint64_t>(1, 1, 320, 128);
  ...
  uint64_t *tmp136 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp137 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp138 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp139 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp140 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp141 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp142 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp143 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp144 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp145 = make_array<uint64_t>(1, 1, 352, 128);
  ...
  uint64_t *tmp146 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp147 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp148 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp149 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp150 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp151 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp152 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp153 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp154 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp155 = make_array<uint64_t>(1, 1, 384, 128);
  ...
  uint64_t *tmp156 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp157 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp158 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp159 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp160 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp161 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp162 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp163 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp164 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp165 = make_array<uint64_t>(1, 1, 416, 128);
  ...
  uint64_t *tmp166 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp167 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp168 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp169 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp170 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp171 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp172 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp173 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp174 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp175 = make_array<uint64_t>(1, 1, 448, 128);
  ...
  uint64_t *tmp176 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp177 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp178 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp179 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp180 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp181 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp182 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp183 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp184 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp185 = make_array<uint64_t>(1, 1, 480, 128);
  ...
  uint64_t *tmp186 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp187 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp188 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp189 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp190 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp191 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp192 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp193 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp194 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp195 = make_array<uint64_t>(1, 1, 512, 256);
  ...
  uint64_t *tmp199 = make_array<uint64_t>(256);
  ...
  uint64_t *tmp200 = make_array<uint64_t>(1, 1, 256, 128);
  ...
  uint64_t *tmp201 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp202 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp203 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp204 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp205 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp206 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp207 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp208 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp209 = make_array<uint64_t>(288);
  ...
  uint64_t *tmp210 = make_array<uint64_t>(1, 1, 288, 128);
  ...
  uint64_t *tmp211 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp212 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp213 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp214 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp215 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp216 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp217 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp218 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp219 = make_array<uint64_t>(320);
  ...
  uint64_t *tmp220 = make_array<uint64_t>(1, 1, 320, 128);
  ...
  uint64_t *tmp221 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp222 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp223 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp224 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp225 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp226 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp227 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp228 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp229 = make_array<uint64_t>(352);
  ...
  uint64_t *tmp230 = make_array<uint64_t>(1, 1, 352, 128);
  ...
  uint64_t *tmp231 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp232 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp233 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp234 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp235 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp236 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp237 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp238 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp239 = make_array<uint64_t>(384);
  ...
  uint64_t *tmp240 = make_array<uint64_t>(1, 1, 384, 128);
  ...
  uint64_t *tmp241 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp242 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp243 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp244 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp245 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp246 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp247 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp248 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp249 = make_array<uint64_t>(416);
  ...
  uint64_t *tmp250 = make_array<uint64_t>(1, 1, 416, 128);
  ...
  uint64_t *tmp251 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp252 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp253 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp254 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp255 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp256 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp257 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp258 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp259 = make_array<uint64_t>(448);
  ...
  uint64_t *tmp260 = make_array<uint64_t>(1, 1, 448, 128);
  ...
  uint64_t *tmp261 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp262 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp263 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp264 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp265 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp266 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp267 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp268 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp269 = make_array<uint64_t>(480);
  ...
  uint64_t *tmp270 = make_array<uint64_t>(1, 1, 480, 128);
  ...
  uint64_t *tmp271 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp272 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp273 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp274 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp275 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp276 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp277 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp278 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp279 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp280 = make_array<uint64_t>(1, 1, 512, 128);
  ...
  uint64_t *tmp281 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp282 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp283 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp284 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp285 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp286 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp287 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp288 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp289 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp290 = make_array<uint64_t>(1, 1, 544, 128);
  ...
  uint64_t *tmp291 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp292 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp293 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp294 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp295 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp296 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp297 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp298 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp299 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp300 = make_array<uint64_t>(1, 1, 576, 128);
  ...
  uint64_t *tmp301 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp302 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp303 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp304 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp305 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp306 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp307 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp308 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp309 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp310 = make_array<uint64_t>(1, 1, 608, 128);
  ...
  uint64_t *tmp311 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp312 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp313 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp314 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp315 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp316 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp317 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp318 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp319 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp320 = make_array<uint64_t>(1, 1, 640, 128);
  ...
  uint64_t *tmp321 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp322 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp323 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp324 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp325 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp326 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp327 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp328 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp329 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp330 = make_array<uint64_t>(1, 1, 672, 128);
  ...
  uint64_t *tmp331 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp332 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp333 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp334 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp335 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp336 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp337 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp338 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp339 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp340 = make_array<uint64_t>(1, 1, 704, 128);
  ...
  uint64_t *tmp341 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp342 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp343 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp344 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp345 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp346 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp347 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp348 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp349 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp350 = make_array<uint64_t>(1, 1, 736, 128);
  ...
  uint64_t *tmp351 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp352 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp353 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp354 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp355 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp356 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp357 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp358 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp359 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp360 = make_array<uint64_t>(1, 1, 768, 128);
  ...
  uint64_t *tmp361 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp362 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp363 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp364 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp365 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp366 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp367 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp368 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp369 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp370 = make_array<uint64_t>(1, 1, 800, 128);
  ...
  uint64_t *tmp371 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp372 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp373 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp374 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp375 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp376 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp377 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp378 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp379 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp380 = make_array<uint64_t>(1, 1, 832, 128);
  ...
  uint64_t *tmp381 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp382 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp383 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp384 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp385 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp386 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp387 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp388 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp389 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp390 = make_array<uint64_t>(1, 1, 864, 128);
  ...
  uint64_t *tmp391 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp392 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp393 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp394 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp395 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp396 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp397 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp398 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp399 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp400 = make_array<uint64_t>(1, 1, 896, 128);
  ...
  uint64_t *tmp401 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp402 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp403 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp404 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp405 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp406 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp407 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp408 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp409 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp410 = make_array<uint64_t>(1, 1, 928, 128);
  ...
  uint64_t *tmp411 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp412 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp413 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp414 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp415 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp416 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp417 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp418 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp419 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp420 = make_array<uint64_t>(1, 1, 960, 128);
  ...
  uint64_t *tmp421 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp422 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp423 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp424 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp425 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp426 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp427 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp428 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp429 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp430 = make_array<uint64_t>(1, 1, 992, 128);
  ...
  uint64_t *tmp431 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp432 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp433 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp434 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp435 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp436 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp437 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp438 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp439 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp440 = make_array<uint64_t>(1, 1, 1024, 512);
  ...
  uint64_t *tmp441 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp442 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp443 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp444 = make_array<uint64_t>(512);
  ...
  uint64_t *tmp445 = make_array<uint64_t>(1, 1, 512, 128);
  ...
  uint64_t *tmp446 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp447 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp448 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp449 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp450 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp451 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp452 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp453 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp454 = make_array<uint64_t>(544);
  ...
  uint64_t *tmp455 = make_array<uint64_t>(1, 1, 544, 128);
  ...
  uint64_t *tmp456 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp457 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp458 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp459 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp460 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp461 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp462 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp463 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp464 = make_array<uint64_t>(576);
  ...
  uint64_t *tmp465 = make_array<uint64_t>(1, 1, 576, 128);
  ...
  uint64_t *tmp466 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp467 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp468 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp469 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp470 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp471 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp472 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp473 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp474 = make_array<uint64_t>(608);
  ...
  uint64_t *tmp475 = make_array<uint64_t>(1, 1, 608, 128);
  ...
  uint64_t *tmp476 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp477 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp478 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp479 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp480 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp481 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp482 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp483 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp484 = make_array<uint64_t>(640);
  ...
  uint64_t *tmp485 = make_array<uint64_t>(1, 1, 640, 128);
  ...
  uint64_t *tmp486 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp487 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp488 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp489 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp490 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp491 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp492 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp493 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp494 = make_array<uint64_t>(672);
  ...
  uint64_t *tmp495 = make_array<uint64_t>(1, 1, 672, 128);
  ...
  uint64_t *tmp496 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp497 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp498 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp499 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp500 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp501 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp502 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp503 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp504 = make_array<uint64_t>(704);
  ...
  uint64_t *tmp505 = make_array<uint64_t>(1, 1, 704, 128);
  ...
  uint64_t *tmp506 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp507 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp508 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp509 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp510 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp511 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp512 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp513 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp514 = make_array<uint64_t>(736);
  ...
  uint64_t *tmp515 = make_array<uint64_t>(1, 1, 736, 128);
  ...
  uint64_t *tmp516 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp517 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp518 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp519 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp520 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp521 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp522 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp523 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp524 = make_array<uint64_t>(768);
  ...
  uint64_t *tmp525 = make_array<uint64_t>(1, 1, 768, 128);
  ...
  uint64_t *tmp526 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp527 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp528 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp529 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp530 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp531 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp532 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp533 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp534 = make_array<uint64_t>(800);
  ...
  uint64_t *tmp535 = make_array<uint64_t>(1, 1, 800, 128);
  ...
  uint64_t *tmp536 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp537 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp538 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp539 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp540 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp541 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp542 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp543 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp544 = make_array<uint64_t>(832);
  ...
  uint64_t *tmp545 = make_array<uint64_t>(1, 1, 832, 128);
  ...
  uint64_t *tmp546 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp547 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp548 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp549 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp550 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp551 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp552 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp553 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp554 = make_array<uint64_t>(864);
  ...
  uint64_t *tmp555 = make_array<uint64_t>(1, 1, 864, 128);
  ...
  uint64_t *tmp556 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp557 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp558 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp559 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp560 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp561 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp562 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp563 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp564 = make_array<uint64_t>(896);
  ...
  uint64_t *tmp565 = make_array<uint64_t>(1, 1, 896, 128);
  ...
  uint64_t *tmp566 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp567 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp568 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp569 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp570 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp571 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp572 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp573 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp574 = make_array<uint64_t>(928);
  ...
  uint64_t *tmp575 = make_array<uint64_t>(1, 1, 928, 128);
  ...
  uint64_t *tmp576 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp577 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp578 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp579 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp580 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp581 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp582 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp583 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp584 = make_array<uint64_t>(960);
  ...
  uint64_t *tmp585 = make_array<uint64_t>(1, 1, 960, 128);
  ...
  uint64_t *tmp586 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp587 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp588 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp589 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp590 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp591 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp592 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp593 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp594 = make_array<uint64_t>(992);
  ...
  uint64_t *tmp595 = make_array<uint64_t>(1, 1, 992, 128);
  ...
  uint64_t *tmp596 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp597 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp598 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp599 = make_array<uint64_t>(128);
  ...
  uint64_t *tmp600 = make_array<uint64_t>(3, 3, 128, 32);
  ...
  uint64_t *tmp601 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp602 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp603 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp604 = make_array<uint64_t>(1024);
  ...
  uint64_t *tmp605 = make_array<uint64_t>(1, 1, 1024, 1000);
  ...
  uint64_t *tmp606 = make_array<uint64_t>(1000);
  ...
  MaxPool(1, 56, 56, 64, 3, 3, 0, 1, 0, 1, 2, 2, 1, 112, 112, 64, tmp610,
          tmp614);
  ClearMemSecret4(1, 112, 112, 64, tmp610);

  uint64_t *tmp616 = make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp614, tmp616, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 64, tmp614);

  uint64_t *tmp618 = make_array<uint64_t>(1, 56, 56, 64);
  FusedBatchNorm4411(1, 56, 56, 64, tmp616, tmp6, tmp7, 0, kScale, tmp618);
  ClearMemSecret1(64, tmp6);
  ClearMemSecret1(64, tmp7);

  uint64_t *tmp621 = make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp618, tmp621, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 64, tmp618);

  uint64_t *tmp626 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 64, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp621, tmp10, tmp11, tmp12, tmp626);
  ClearMemSecret4(1, 1, 64, 128, tmp10);
  ClearMemSecret4(1, 56, 56, 64, tmp621);
  ClearMemSecret1(128, tmp11);
  ClearMemSecret1(128, tmp12);

  uint64_t *tmp630 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp626, tmp630, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp626);

  uint64_t *tmp632 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp630, tmp15,
                tmp632);
  ClearMemSecret4(1, 56, 56, 128, tmp630);
  ClearMemSecret4(3, 3, 128, 32, tmp15);

  int64_t tmp635 = 3;

  uint64_t *tmp636 = make_array<uint64_t>(1, 56, 56, 96);
  ScaleDown4(1, 56, 56, 32, tmp632, kScale);

  Concat2T444(1, 56, 56, 96, 1, 56, 56, 64, tmp616, 1, 56, 56, 32, tmp632, tmp635, tmp636);
  ClearMemSecret4(1, 56, 56, 64, tmp616);
  ClearMemSecret4(1, 56, 56, 32, tmp632);
  ClearMemPublic(tmp635);

  uint64_t *tmp640 = make_array<uint64_t>(1, 56, 56, 96);
  FusedBatchNorm4411(1, 56, 56, 96, tmp636, tmp16, tmp17, 0, kScale, tmp640);
  ClearMemSecret1(96, tmp16);
  ClearMemSecret1(96, tmp17);

  uint64_t *tmp643 = make_array<uint64_t>(1, 56, 56, 96);
  Relu4(1, 56, 56, 96, tmp640, tmp643, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 96, tmp640);

  uint64_t *tmp648 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 96, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp643, tmp20, tmp21, tmp22, tmp648);
  ClearMemSecret4(1, 56, 56, 96, tmp643);
  ClearMemSecret4(1, 1, 96, 128, tmp20);
  ClearMemSecret1(128, tmp21);
  ClearMemSecret1(128, tmp22);

  uint64_t *tmp652 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp648, tmp652, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp648);

  uint64_t *tmp654 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp652, tmp25,
                tmp654);
  ClearMemSecret4(1, 56, 56, 128, tmp652);
  ClearMemSecret4(3, 3, 128, 32, tmp25);

  int64_t tmp657 = 3;

  uint64_t *tmp658 = make_array<uint64_t>(1, 56, 56, 128);
  ScaleDown4(1, 56, 56, 32, tmp654, kScale);
  Concat2T444(1, 56, 56, 128, 1, 56, 56, 96, tmp636, 1, 56, 56, 32, tmp654,
              tmp657, tmp658);
  ClearMemSecret4(1, 56, 56, 96, tmp636);
  ClearMemSecret4(1, 56, 56, 32, tmp654);
  ClearMemPublic(tmp657);

  uint64_t *tmp662 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBatchNorm4411(1, 56, 56, 128, tmp658, tmp26, tmp27, 0, kScale, tmp662);
  ClearMemSecret1(128, tmp27);
  ClearMemSecret1(128, tmp26);

  uint64_t *tmp665 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp662, tmp665, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp662);

  uint64_t *tmp670 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 128, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp665, tmp30, tmp31, tmp32, tmp670);
  ClearMemSecret4(1, 56, 56, 128, tmp665);
  ClearMemSecret4(1, 1, 128, 128, tmp30);
  ClearMemSecret1(128, tmp31);
  ClearMemSecret1(128, tmp32);

  uint64_t *tmp674 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp670, tmp674, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp670);

  uint64_t *tmp676 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp674, tmp35,
                tmp676);
  ClearMemSecret4(3, 3, 128, 32, tmp35);
  ClearMemSecret4(1, 56, 56, 128, tmp674);

  int64_t tmp679 = 3;

  uint64_t *tmp680 = make_array<uint64_t>(1, 56, 56, 160);
  ScaleDown4(1, 56, 56, 32, tmp676, kScale);
  Concat2T444(1, 56, 56, 160, 1, 56, 56, 128, tmp658, 1, 56, 56, 32, tmp676,
              tmp679, tmp680);
  ClearMemPublic(tmp679);
  ClearMemSecret4(1, 56, 56, 32, tmp676);
  ClearMemSecret4(1, 56, 56, 128, tmp658);

  uint64_t *tmp684 = make_array<uint64_t>(1, 56, 56, 160);
  FusedBatchNorm4411(1, 56, 56, 160, tmp680, tmp36, tmp37, 0, kScale, tmp684);
  ClearMemSecret1(160, tmp37);
  ClearMemSecret1(160, tmp36);

  uint64_t *tmp687 = make_array<uint64_t>(1, 56, 56, 160);
  Relu4(1, 56, 56, 160, tmp684, tmp687, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 160, tmp684);

  uint64_t *tmp692 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 160, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp687, tmp40, tmp41, tmp42, tmp692);
  ClearMemSecret4(1, 1, 160, 128, tmp40);
  ClearMemSecret4(1, 56, 56, 160, tmp687);
  ClearMemSecret1(128, tmp41);
  ClearMemSecret1(128, tmp42);

  uint64_t *tmp696 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp692, tmp696, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp692);

  uint64_t *tmp698 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp696, tmp45,
                tmp698);
  ClearMemSecret4(3, 3, 128, 32, tmp45);
  ClearMemSecret4(1, 56, 56, 128, tmp696);

  int64_t tmp701 = 3;

  uint64_t *tmp702 = make_array<uint64_t>(1, 56, 56, 192);
  ScaleDown4(1, 56, 56, 32, tmp698, kScale);
  Concat2T444(1, 56, 56, 192, 1, 56, 56, 160, tmp680, 1, 56, 56, 32, tmp698,
              tmp701, tmp702);
  ClearMemSecret4(1, 56, 56, 32, tmp698);
  ClearMemSecret4(1, 56, 56, 160, tmp680);
  ClearMemPublic(tmp701);

  uint64_t *tmp706 = make_array<uint64_t>(1, 56, 56, 192);
  FusedBatchNorm4411(1, 56, 56, 192, tmp702, tmp46, tmp47, 0, kScale, tmp706);
  ClearMemSecret1(192, tmp47);
  ClearMemSecret1(192, tmp46);

  uint64_t *tmp709 = make_array<uint64_t>(1, 56, 56, 192);
  Relu4(1, 56, 56, 192, tmp706, tmp709, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 192, tmp706);

  uint64_t *tmp714 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 192, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp709, tmp50, tmp51, tmp52, tmp714);
  ClearMemSecret4(1, 56, 56, 192, tmp709);
  ClearMemSecret4(1, 1, 192, 128, tmp50);
  ClearMemSecret1(128, tmp51);
  ClearMemSecret1(128, tmp52);

  uint64_t *tmp718 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp714, tmp718, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp714);

  uint64_t *tmp720 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp718, tmp55,
                tmp720);
  ClearMemSecret4(3, 3, 128, 32, tmp55);
  ClearMemSecret4(1, 56, 56, 128, tmp718);

  int64_t tmp723 = 3;

  uint64_t *tmp724 = make_array<uint64_t>(1, 56, 56, 224);
  ScaleDown4(1, 56, 56, 32, tmp720, kScale);
  Concat2T444(1, 56, 56, 224, 1, 56, 56, 192, tmp702, 1, 56, 56, 32, tmp720,
              tmp723, tmp724);
  ClearMemSecret4(1, 56, 56, 32, tmp720);
  ClearMemSecret4(1, 56, 56, 192, tmp702);
  ClearMemPublic(tmp723);

  uint64_t *tmp728 = make_array<uint64_t>(1, 56, 56, 224);
  FusedBatchNorm4411(1, 56, 56, 224, tmp724, tmp56, tmp57, 0, kScale, tmp728);
  ClearMemSecret1(224, tmp56);
  ClearMemSecret1(224, tmp57);

  uint64_t *tmp731 = make_array<uint64_t>(1, 56, 56, 224);
  Relu4(1, 56, 56, 224, tmp728, tmp731, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 224, tmp728);

  uint64_t *tmp736 = make_array<uint64_t>(1, 56, 56, 128);
  FusedBN(1, 56, 56, 224, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp731, tmp60, tmp61, tmp62, tmp736);
  ClearMemSecret4(1, 56, 56, 224, tmp731);
  ClearMemSecret4(1, 1, 224, 128, tmp60);
  ClearMemSecret1(128, tmp61);
  ClearMemSecret1(128, tmp62);
  
  uint64_t *tmp740 = make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp736, tmp740, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp736);

  uint64_t *tmp742 = make_array<uint64_t>(1, 56, 56, 32);
  Conv2DWrapper_seperate(1, 56, 56, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp740, tmp65,
                tmp742);
  ClearMemSecret4(3, 3, 128, 32, tmp65);
  ClearMemSecret4(1, 56, 56, 128, tmp740);

  int64_t tmp745 = 3;

  uint64_t *tmp746 = make_array<uint64_t>(1, 56, 56, 256);
  ScaleDown4(1, 56, 56, 32, tmp742, kScale);
  Concat2T444(1, 56, 56, 256, 1, 56, 56, 224, tmp724, 1, 56, 56, 32, tmp742,
              tmp745, tmp746);
  ClearMemSecret4(1, 56, 56, 224, tmp724);
  ClearMemPublic(tmp745);
  ClearMemSecret4(1, 56, 56, 32, tmp742);

  uint64_t *tmp750 = make_array<uint64_t>(1, 56, 56, 256);
  FusedBatchNorm4411(1, 56, 56, 256, tmp746, tmp66, tmp67, 0, kScale, tmp750);
  ClearMemSecret4(1, 56, 56, 256, tmp746);
  ClearMemSecret1(256, tmp66);
  ClearMemSecret1(256, tmp67);

  uint64_t *tmp754 = make_array<uint64_t>(1, 56, 56, 256);
  Relu4(1, 56, 56, 256, tmp750, tmp754, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 256, tmp750);

  uint64_t *tmp756 = make_array<uint64_t>(1, 56, 56, 128);
  Conv2DWrapper_seperate(1, 56, 56, 256, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp754, tmp70, tmp756);
  ClearMemSecret4(1, 56, 56, 256, tmp754);
  ClearMemSecret4(1, 1, 256, 128, tmp70);

  uint64_t *tmp759 = make_array<uint64_t>(1, 28, 28, 128);
  AvgPool(1, 28, 28, 128, 2, 2, 0, 0, 0, 0, 2, 2, 1, 56, 56, 128, tmp756, tmp759);
  ClearMemSecret4(1, 56, 56, 128, tmp756);

  uint64_t *tmp761 = make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp759, kScale);
  FusedBatchNorm4411(1, 28, 28, 128, tmp759, tmp71, tmp72, 0, kScale, tmp761);
  ClearMemSecret1(128, tmp72);
  ClearMemSecret1(128, tmp71);

  uint64_t *tmp764 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp761, tmp764, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp761);

  uint64_t *tmp769 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 128, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp764, tmp75, tmp76, tmp77, tmp769);
  ClearMemSecret4(1, 28, 28, 128, tmp764);
  ClearMemSecret4(1, 1, 128, 128, tmp75);
  ClearMemSecret4(1, 28, 28, 128, tmp76);
  ClearMemSecret1(128, tmp77);

  uint64_t *tmp773 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp769, tmp773, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp769);

  uint64_t *tmp775 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp773, tmp80,
                tmp775);
  ClearMemSecret4(1, 28, 28, 128, tmp773);
  ClearMemSecret4(3, 3, 128, 32, tmp80);

  int64_t tmp778 = 3;

  uint64_t *tmp779 = make_array<uint64_t>(1, 28, 28, 160);
  ScaleDown4(1, 28, 28, 32, tmp775, kScale);
  Concat2T444(1, 28, 28, 160, 1, 28, 28, 128, tmp759, 1, 28, 28, 32, tmp775,
              tmp778, tmp779);
  ClearMemSecret4(1, 28, 28, 128, tmp759);
  ClearMemPublic(tmp778);
  ClearMemSecret4(1, 28, 28, 32, tmp775);

  uint64_t *tmp783 = make_array<uint64_t>(1, 28, 28, 160);
  FusedBatchNorm4411(1, 28, 28, 160, tmp779, tmp81, tmp82, 0, kScale, tmp783);
  ClearMemSecret1(160, tmp82);
  ClearMemSecret1(160, tmp81);

  uint64_t *tmp786 = make_array<uint64_t>(1, 28, 28, 160);
  Relu4(1, 28, 28, 160, tmp783, tmp786, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 160, tmp783);

  uint64_t *tmp791 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 160, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp786, tmp85, tmp86, tmp87, tmp791);
  ClearMemSecret4(1, 1, 160, 128, tmp85);
  ClearMemSecret4(1, 28, 28, 160, tmp786);
  ClearMemSecret1(128, tmp86);
  ClearMemSecret1(128, tmp87);

  uint64_t *tmp795 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp791, tmp795, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp791);

  uint64_t *tmp797 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp795, tmp90,
                tmp797);
  ClearMemSecret4(1, 28, 28, 128, tmp795);
  ClearMemSecret4(3, 3, 128, 32, tmp90);

  int64_t tmp800 = 3;

  uint64_t *tmp801 = make_array<uint64_t>(1, 28, 28, 192);
  ScaleDown4(1, 28, 28, 32, tmp797, kScale);
  Concat2T444(1, 28, 28, 192, 1, 28, 28, 160, tmp779, 1, 28, 28, 32, tmp797,
              tmp800, tmp801);
  ClearMemSecret4(1, 28, 28, 160, tmp779);
  ClearMemPublic(tmp800);
  ClearMemSecret4(1, 28, 28, 32, tmp797);

  uint64_t *tmp805 = make_array<uint64_t>(1, 28, 28, 192);
  FusedBatchNorm4411(1, 28, 28, 192, tmp801, tmp91, tmp92, 0, kScale, tmp805);
  ClearMemSecret1(192, tmp92);
  ClearMemSecret1(192, tmp91);

  uint64_t *tmp808 = make_array<uint64_t>(1, 28, 28, 192);
  Relu4(1, 28, 28, 192, tmp805, tmp808, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 192, tmp805);

  uint64_t *tmp813 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 192, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp808, tmp95, tmp96, tmp97, tmp813);
  ClearMemSecret4(1, 1, 192, 128, tmp95);
  ClearMemSecret4(1, 28, 28, 192, tmp808);
  ClearMemSecret1(128, tmp96);
  ClearMemSecret1(128, tmp97);

  uint64_t *tmp817 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp813, tmp817, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp813);

  uint64_t *tmp819 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp817, tmp100,
                tmp819);
  ClearMemSecret4(3, 3, 128, 32, tmp100);
  ClearMemSecret4(1, 28, 28, 128, tmp817);

  int64_t tmp822 = 3;

  uint64_t *tmp823 = make_array<uint64_t>(1, 28, 28, 224);
  ScaleDown4(1, 28, 28, 32, tmp819, kScale);
  Concat2T444(1, 28, 28, 224, 1, 28, 28, 192, tmp801, 1, 28, 28, 32, tmp819,
              tmp822, tmp823);
  ClearMemPublic(tmp822);
  ClearMemSecret4(1, 28, 28, 192, tmp801);
  ClearMemSecret4(1, 28, 28, 32, tmp819);

  uint64_t *tmp827 = make_array<uint64_t>(1, 28, 28, 224);
  FusedBatchNorm4411(1, 28, 28, 224, tmp823, tmp101, tmp102, 0, kScale, tmp827);
  ClearMemSecret1(224, tmp102);
  ClearMemSecret1(224, tmp101);

  uint64_t *tmp830 = make_array<uint64_t>(1, 28, 28, 224);
  Relu4(1, 28, 28, 224, tmp827, tmp830, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 224, tmp827);

  uint64_t *tmp832 = make_array<uint64_t>(1, 28, 28, 128);
  Conv2DWrapper_seperate(1, 28, 28, 224, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp830, tmp105,
                tmp832);
  ClearMemSecret4(1, 1, 224, 128, tmp105);
  ClearMemSecret4(1, 28, 28, 224, tmp830);

  uint64_t *tmp835 = make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp832, kScale);
  FusedBatchNorm4411(1, 28, 28, 128, tmp832, tmp106, tmp107, 0, kScale, tmp835);
  ClearMemSecret1(128, tmp107);
  ClearMemSecret1(128, tmp106);
  ClearMemSecret4(1, 28, 28, 128, tmp832);

  uint64_t *tmp839 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp835, tmp839, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp835);

  uint64_t *tmp841 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp839, tmp110,
                tmp841);
  ClearMemSecret4(1, 28, 28, 128, tmp839);
  ClearMemSecret4(3, 3, 128, 32, tmp110);

  int64_t tmp844 = 3;

  uint64_t *tmp845 = make_array<uint64_t>(1, 28, 28, 256);
  ScaleDown4(1, 28, 28, 32, tmp841, kScale);
  Concat2T444(1, 28, 28, 256, 1, 28, 28, 224, tmp823, 1, 28, 28, 32, tmp841,
              tmp844, tmp845);
  ClearMemSecret4(1, 28, 28, 224, tmp823);
  ClearMemPublic(tmp844);
  ClearMemSecret4(1, 28, 28, 32, tmp841);

  uint64_t *tmp849 = make_array<uint64_t>(1, 28, 28, 256);
  FusedBatchNorm4411(1, 28, 28, 256, tmp845, tmp111, tmp112, 0, kScale, tmp849);
  ClearMemSecret1(256, tmp111);
  ClearMemSecret1(256, tmp112);

  uint64_t *tmp852 = make_array<uint64_t>(1, 28, 28, 256);
  Relu4(1, 28, 28, 256, tmp849, tmp852, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 256, tmp849);

  uint64_t *tmp857 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 256, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp852, tmp115, tmp116, tmp117, tmp857);
  ClearMemSecret4(1, 1, 256, 128, tmp115);
  ClearMemSecret4(1, 28, 28, 256, tmp852);
  ClearMemSecret1(128, tmp116);
  ClearMemSecret1(128, tmp117);

  uint64_t *tmp861 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp857, tmp861, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp857);

  uint64_t *tmp863 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp861, tmp120,
                tmp863);
  ClearMemSecret4(1, 28, 28, 128, tmp861);
  ClearMemSecret4(3, 3, 128, 32, tmp120);

  int64_t tmp866 = 3;

  uint64_t *tmp867 = make_array<uint64_t>(1, 28, 28, 288);
  ScaleDown4(1, 28, 28, 32, tmp863, kScale);
  Concat2T444(1, 28, 28, 288, 1, 28, 28, 256, tmp845, 1, 28, 28, 32, tmp863,
              tmp866, tmp867);
  ClearMemSecret4(1, 28, 28, 32, tmp863);
  ClearMemPublic(tmp866);
  ClearMemSecret4(1, 28, 28, 256, tmp845);

  uint64_t *tmp871 = make_array<uint64_t>(1, 28, 28, 288);
  FusedBatchNorm4411(1, 28, 28, 288, tmp867, tmp121, tmp122, 0, kScale, tmp871);
  ClearMemSecret1(288, tmp121);
  ClearMemSecret1(288, tmp122);

  uint64_t *tmp874 = make_array<uint64_t>(1, 28, 28, 288);
  Relu4(1, 28, 28, 288, tmp871, tmp874, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 288, tmp871);

  uint64_t *tmp879 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 288, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp874, tmp125, tmp126, tmp127, tmp879);
  ClearMemSecret4(1, 28, 28, 288, tmp874);
  ClearMemSecret4(1, 1, 288, 128, tmp125);
  ClearMemSecret1(128, tmp126);
  ClearMemSecret1(128, tmp127);
  
  uint64_t *tmp883 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp879, tmp883, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp879);

  uint64_t *tmp885 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp883, tmp130,
                tmp885);
  ClearMemSecret4(1, 28, 28, 128, tmp883);
  ClearMemSecret4(3, 3, 128, 32, tmp130);

  int64_t tmp888 = 3;

  uint64_t *tmp889 = make_array<uint64_t>(1, 28, 28, 320);
  ScaleDown4(1, 28, 28, 32, tmp885, kScale);
  Concat2T444(1, 28, 28, 320, 1, 28, 28, 288, tmp867, 1, 28, 28, 32, tmp885,
              tmp888, tmp889);
  ClearMemPublic(tmp888);
  ClearMemSecret4(1, 28, 28, 288, tmp867);
  ClearMemSecret4(1, 28, 28, 32, tmp885);

  uint64_t *tmp893 = make_array<uint64_t>(1, 28, 28, 320);
  FusedBatchNorm4411(1, 28, 28, 320, tmp889, tmp131, tmp132, 0, kScale, tmp893);
  ClearMemSecret1(320, tmp131);
  ClearMemSecret1(320, tmp132);

  uint64_t *tmp896 = make_array<uint64_t>(1, 28, 28, 320);
  Relu4(1, 28, 28, 320, tmp893, tmp896, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 320, tmp893);

  uint64_t *tmp901 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 320, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp896, tmp135, tmp136, tmp137, tmp901);
  ClearMemSecret4(1, 28, 28, 320, tmp896);
  ClearMemSecret4(1, 1, 320, 128, tmp135);
  ClearMemSecret1(128, tmp136);
  ClearMemSecret1(128, tmp137);

  uint64_t *tmp905 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp901, tmp905, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp901);

  uint64_t *tmp907 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp905, tmp140,
                tmp907);
  ClearMemSecret4(3, 3, 128, 32, tmp140);
  ClearMemSecret4(1, 28, 28, 128, tmp905);

  int64_t tmp910 = 3;

  uint64_t *tmp911 = make_array<uint64_t>(1, 28, 28, 352);
  ScaleDown4(1, 28, 28, 32, tmp907, kScale);
  Concat2T444(1, 28, 28, 352, 1, 28, 28, 320, tmp889, 1, 28, 28, 32, tmp907,
              tmp910, tmp911);
  ClearMemPublic(tmp910);
  ClearMemSecret4(1, 28, 28, 32, tmp907);
  ClearMemSecret4(1, 28, 28, 320, tmp889);

  uint64_t *tmp915 = make_array<uint64_t>(1, 28, 28, 352);
  FusedBatchNorm4411(1, 28, 28, 352, tmp911, tmp141, tmp142, 0, kScale, tmp915);
  ClearMemSecret1(352, tmp142);
  ClearMemSecret1(352, tmp141);

  uint64_t *tmp918 = make_array<uint64_t>(1, 28, 28, 352);
  Relu4(1, 28, 28, 352, tmp915, tmp918, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 352, tmp915);

  uint64_t *tmp923 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 352, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp918, tmp145, tmp146, tmp147, tmp923);
  ClearMemSecret4(1, 28, 28, 352, tmp918);
  ClearMemSecret4(1, 1, 352, 128, tmp145);
  ClearMemSecret1(128, tmp146);
  ClearMemSecret1(128, tmp147);

  uint64_t *tmp927 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp923, tmp927, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp923);

  uint64_t *tmp929 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp927, tmp150,
                tmp929);
  ClearMemSecret4(3, 3, 128, 32, tmp150);
  ClearMemSecret4(1, 28, 28, 128, tmp927);

  int64_t tmp932 = 3;

  uint64_t *tmp933 = make_array<uint64_t>(1, 28, 28, 384);
  ScaleDown4(1, 28, 28, 32, tmp929, kScale);
  Concat2T444(1, 28, 28, 384, 1, 28, 28, 352, tmp911, 1, 28, 28, 32, tmp929,
              tmp932, tmp933);
  ClearMemPublic(tmp932);
  ClearMemSecret4(1, 28, 28, 32, tmp929);
  ClearMemSecret4(1, 28, 28, 352, tmp911);

  uint64_t *tmp937 = make_array<uint64_t>(1, 28, 28, 384);
  FusedBatchNorm4411(1, 28, 28, 384, tmp933, tmp151, tmp152, 0, kScale, tmp937);
  ClearMemSecret1(384, tmp152);
  ClearMemSecret1(384, tmp151);

  uint64_t *tmp940 = make_array<uint64_t>(1, 28, 28, 384);
  Relu4(1, 28, 28, 384, tmp937, tmp940, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 384, tmp937);

  uint64_t *tmp945 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 384, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp940, tmp155, tmp156, tmp157, tmp945);
  ClearMemSecret4(1, 1, 384, 128, tmp155);
  ClearMemSecret4(1, 28, 28, 384, tmp940);
  ClearMemSecret1(128, tmp156);
  ClearMemSecret1(128, tmp157);

  uint64_t *tmp949 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp945, tmp949, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp945);

  uint64_t *tmp951 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp949, tmp160,
                tmp951);
  ClearMemSecret4(1, 28, 28, 128, tmp949);
  ClearMemSecret4(3, 3, 128, 32, tmp160);

  int64_t tmp954 = 3;

  uint64_t *tmp955 = make_array<uint64_t>(1, 28, 28, 416);
  ScaleDown4(1, 28, 28, 32, tmp951, kScale);
  Concat2T444(1, 28, 28, 416, 1, 28, 28, 384, tmp933, 1, 28, 28, 32, tmp951,
              tmp954, tmp955);
  ClearMemSecret4(1, 28, 28, 32, tmp951);
  ClearMemPublic(tmp954);
  ClearMemSecret4(1, 28, 28, 384, tmp933);

  uint64_t *tmp959 = make_array<uint64_t>(1, 28, 28, 416);
  FusedBatchNorm4411(1, 28, 28, 416, tmp955, tmp161, tmp162, 0, kScale, tmp959);
  ClearMemSecret1(416, tmp161);
  ClearMemSecret1(416, tmp162);

  uint64_t *tmp962 = make_array<uint64_t>(1, 28, 28, 416);
  Relu4(1, 28, 28, 416, tmp959, tmp962, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 416, tmp959);

  uint64_t *tmp967 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 416, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp962, tmp165, tmp166, tmp167, tmp967);
  ClearMemSecret4(1, 28, 28, 416, tmp962);
  ClearMemSecret4(1, 1, 416, 128, tmp165);
  ClearMemSecret1(128, tmp166);
  ClearMemSecret1(128, tmp167);

  uint64_t *tmp971 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp967, tmp971, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp967);

  uint64_t *tmp973 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp971, tmp170,
                tmp973);
  ClearMemSecret4(1, 28, 28, 128, tmp971);
  ClearMemSecret4(3, 3, 128, 32, tmp170);

  int64_t tmp976 = 3;

  uint64_t *tmp977 = make_array<uint64_t>(1, 28, 28, 448);
  ScaleDown4(1, 28, 28, 32, tmp973, kScale);
  Concat2T444(1, 28, 28, 448, 1, 28, 28, 416, tmp955, 1, 28, 28, 32, tmp973,
              tmp976, tmp977);
  ClearMemPublic(tmp976);
  ClearMemSecret4(1, 28, 28, 416, tmp955);
  ClearMemSecret4(1, 28, 28, 32, tmp973);

  uint64_t *tmp981 = make_array<uint64_t>(1, 28, 28, 448);
  FusedBatchNorm4411(1, 28, 28, 448, tmp977, tmp171, tmp172, 0, kScale, tmp981);
  ClearMemSecret1(448, tmp172);
  ClearMemSecret1(448, tmp171);

  uint64_t *tmp984 = make_array<uint64_t>(1, 28, 28, 448);
  Relu4(1, 28, 28, 448, tmp981, tmp984, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 448, tmp981);

  uint64_t *tmp989 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 448, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp984, tmp175, tmp176, tmp177, tmp989);
  ClearMemSecret4(1, 1, 448, 128, tmp175);
  ClearMemSecret4(1, 28, 28, 448, tmp984);
  ClearMemSecret1(128, tmp176);
  ClearMemSecret1(128, tmp177);

  uint64_t *tmp993 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp989, tmp993, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp989);

  uint64_t *tmp995 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp993, tmp180,
                tmp995);
  ClearMemSecret4(3, 3, 128, 32, tmp180);
  ClearMemSecret4(1, 28, 28, 128, tmp993);

  int64_t tmp998 = 3;

  uint64_t *tmp999 = make_array<uint64_t>(1, 28, 28, 480);
  ScaleDown4(1, 28, 28, 32, tmp995, kScale);
  Concat2T444(1, 28, 28, 480, 1, 28, 28, 448, tmp977, 1, 28, 28, 32, tmp995,
              tmp998, tmp999);
  ClearMemSecret4(1, 28, 28, 448, tmp977);
  ClearMemPublic(tmp998);
  ClearMemSecret4(1, 28, 28, 32, tmp995);

  uint64_t *tmp1003 = make_array<uint64_t>(1, 28, 28, 480);
  FusedBatchNorm4411(1, 28, 28, 480, tmp999, tmp181, tmp182, 0, kScale, tmp1003);
  ClearMemSecret1(480, tmp182);
  ClearMemSecret1(480, tmp181);

  uint64_t *tmp1006 = make_array<uint64_t>(1, 28, 28, 480);
  Relu4(1, 28, 28, 480, tmp1003, tmp1006, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 480, tmp1003);

  uint64_t *tmp1011 = make_array<uint64_t>(1, 28, 28, 128);
  FusedBN(1, 28, 28, 480, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1006, tmp185, tmp186, tmp187, tmp1011);
  ClearMemSecret4(1, 1, 480, 128, tmp185);
  ClearMemSecret4(1, 28, 28, 480, tmp1006);
  ClearMemSecret1(128, tmp186);
  ClearMemSecret1(128, tmp187);

  uint64_t *tmp1015 = make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp1011, tmp1015, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 128, tmp1011);

  uint64_t *tmp1017 = make_array<uint64_t>(1, 28, 28, 32);
  Conv2DWrapper_seperate(1, 28, 28, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1015, tmp190,
                tmp1017);
  ClearMemSecret4(3, 3, 128, 32, tmp190);
  ClearMemSecret4(1, 28, 28, 128, tmp1015);

  int64_t tmp1020 = 3;

  uint64_t *tmp1021 = make_array<uint64_t>(1, 28, 28, 512);
  ScaleDown4(1, 28, 28, 32, tmp1017, kScale);
  Concat2T444(1, 28, 28, 512, 1, 28, 28, 480, tmp999, 1, 28, 28, 32, tmp1017,
              tmp1020, tmp1021);
  ClearMemSecret4(1, 28, 28, 480, tmp999);
  ClearMemPublic(tmp1020);
  ClearMemSecret4(1, 28, 28, 32, tmp1017);

  uint64_t *tmp1025 = make_array<uint64_t>(1, 28, 28, 512);
  FusedBatchNorm4411(1, 28, 28, 512, tmp1021, tmp191, tmp192, 0, kScale, tmp1025);
  ClearMemSecret1(512, tmp192);
  ClearMemSecret1(512, tmp191);
  ClearMemSecret4(1, 28, 28, 512, tmp1021);

  uint64_t *tmp1029 = make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp1025, tmp1029, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 512, tmp1025);

  uint64_t *tmp1031 = make_array<uint64_t>(1, 28, 28, 256);
  Conv2DWrapper_seperate(1, 28, 28, 512, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp1029, tmp195,
                tmp1031);
  ClearMemSecret4(1, 1, 512, 256, tmp195);
  ClearMemSecret4(1, 28, 28, 512, tmp1029);

  uint64_t *tmp1034 = make_array<uint64_t>(1, 14, 14, 256);
  AvgPool(1, 14, 14, 256, 2, 2, 0, 0, 0, 0, 2, 2, 1, 28, 28, 256, tmp1031,
          tmp1034);
  ClearMemSecret4(1, 28, 28, 256, tmp1031);

  uint64_t *tmp1036 = make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp1034, kScale);
  FusedBatchNorm4411(1, 14, 14, 256, tmp1034, tmp196, tmp197, 0, kScale, tmp1036);
  ClearMemSecret1(256, tmp197);
  ClearMemSecret1(256, tmp196);

  uint64_t *tmp1039 = make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp1036, tmp1039, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 256, tmp1036);

  uint64_t *tmp1044 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 256, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1039, tmp200, tmp201, tmp202, tmp1044);
  ClearMemSecret4(1, 1, 256, 128, tmp200);
  ClearMemSecret4(1, 14, 14, 256, tmp1039);
  ClearMemSecret1(128, tmp201);
  ClearMemSecret1(128, tmp202);

  uint64_t *tmp1048 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1044, tmp1048, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1044);

  uint64_t *tmp1050 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1048, tmp205,
                tmp1050);
  ClearMemSecret4(1, 14, 14, 128, tmp1048);
  ClearMemSecret4(3, 3, 128, 32, tmp205);

  int64_t tmp1053 = 3;

  uint64_t *tmp1054 = make_array<uint64_t>(1, 14, 14, 288);
  ScaleDown4(1, 14, 14, 32, tmp1050, kScale);
  Concat2T444(1, 14, 14, 288, 1, 14, 14, 256, tmp1034, 1, 14, 14, 32, tmp1050,
              tmp1053, tmp1054);
  ClearMemSecret4(1, 14, 14, 32, tmp1050);
  ClearMemSecret4(1, 14, 14, 256, tmp1034);
  ClearMemPublic(tmp1053);

  uint64_t *tmp1058 = make_array<uint64_t>(1, 14, 14, 288);
  FusedBatchNorm4411(1, 14, 14, 288, tmp1054, tmp206, tmp207, 0, kScale, tmp1058);
  ClearMemSecret1(288, tmp206);
  ClearMemSecret1(288, tmp207);

  uint64_t *tmp1061 = make_array<uint64_t>(1, 14, 14, 288);
  Relu4(1, 14, 14, 288, tmp1058, tmp1061, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 288, tmp1058);

  uint64_t *tmp1066 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 288, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1061, tmp210, tmp211, tmp212, tmp1066);
  ClearMemSecret4(1, 1, 288, 128, tmp210);
  ClearMemSecret4(1, 14, 14, 288, tmp1061);
  ClearMemSecret1(128, tmp211);
  ClearMemSecret1(128, tmp212);

  uint64_t *tmp1070 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1066, tmp1070, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1066);

  uint64_t *tmp1072 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1070, tmp215,
                tmp1072);
  ClearMemSecret4(3, 3, 128, 32, tmp215);
  ClearMemSecret4(1, 14, 14, 128, tmp1070);

  int64_t tmp1075 = 3;

  uint64_t *tmp1076 = make_array<uint64_t>(1, 14, 14, 320);
  ScaleDown4(1, 14, 14, 32, tmp1072, kScale);
  Concat2T444(1, 14, 14, 320, 1, 14, 14, 288, tmp1054, 1, 14, 14, 32, tmp1072,
              tmp1075, tmp1076);
  ClearMemSecret4(1, 14, 14, 288, tmp1054);
  ClearMemSecret4(1, 14, 14, 32, tmp1072);
  ClearMemPublic(tmp1075);

  uint64_t *tmp1080 = make_array<uint64_t>(1, 14, 14, 320);
  FusedBatchNorm4411(1, 14, 14, 320, tmp1076, tmp216, tmp217, 0, kScale, tmp1080);
  ClearMemSecret1(320, tmp216);
  ClearMemSecret1(320, tmp217);

  uint64_t *tmp1083 = make_array<uint64_t>(1, 14, 14, 320);
  Relu4(1, 14, 14, 320, tmp1080, tmp1083, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 320, tmp1080);

  uint64_t *tmp1088 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 320, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1083, tmp220, tmp221, tmp222, tmp1088);
  ClearMemSecret4(1, 1, 320, 128, tmp220);
  ClearMemSecret4(1, 14, 14, 320, tmp1083);
  ClearMemSecret1(128, tmp221);
  ClearMemSecret1(128, tmp222);

  uint64_t *tmp1092 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1088, tmp1092, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1088);

  uint64_t *tmp1094 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1092, tmp225,
                tmp1094);
  ClearMemSecret4(1, 14, 14, 128, tmp1092);
  ClearMemSecret4(3, 3, 128, 32, tmp225);

  int64_t tmp1097 = 3;

  uint64_t *tmp1098 = make_array<uint64_t>(1, 14, 14, 352);
  ScaleDown4(1, 14, 14, 32, tmp1094, kScale);
  Concat2T444(1, 14, 14, 352, 1, 14, 14, 320, tmp1076, 1, 14, 14, 32, tmp1094,
              tmp1097, tmp1098);
  ClearMemPublic(tmp1097);
  ClearMemSecret4(1, 14, 14, 32, tmp1094);
  ClearMemSecret4(1, 14, 14, 320, tmp1076);

  uint64_t *tmp1102 = make_array<uint64_t>(1, 14, 14, 352);
  FusedBatchNorm4411(1, 14, 14, 352, tmp1098, tmp226, tmp227, 0, kScale, tmp1102);
  ClearMemSecret1(352, tmp227);
  ClearMemSecret1(352, tmp226);

  uint64_t *tmp1105 = make_array<uint64_t>(1, 14, 14, 352);
  Relu4(1, 14, 14, 352, tmp1102, tmp1105, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 352, tmp1102);

  uint64_t *tmp1110 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 352, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1105, tmp230, tmp231, tmp232, tmp1110);
  ClearMemSecret4(1, 1, 352, 128, tmp230);
  ClearMemSecret4(1, 14, 14, 352, tmp1105);
  ClearMemSecret1(128, tmp231);
  ClearMemSecret1(128, tmp232);

  uint64_t *tmp1114 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1110, tmp1114, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1110);

  uint64_t *tmp1116 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1114, tmp235,
                tmp1116);
  ClearMemSecret4(3, 3, 128, 32, tmp235);
  ClearMemSecret4(1, 14, 14, 128, tmp1114);

  int64_t tmp1119 = 3;

  uint64_t *tmp1120 = make_array<uint64_t>(1, 14, 14, 384);
  ScaleDown4(1, 14, 14, 32, tmp1116, kScale);
  Concat2T444(1, 14, 14, 384, 1, 14, 14, 352, tmp1098, 1, 14, 14, 32, tmp1116,
              tmp1119, tmp1120);
  ClearMemSecret4(1, 14, 14, 32, tmp1116);
  ClearMemPublic(tmp1119);
  ClearMemSecret4(1, 14, 14, 352, tmp1098);

  uint64_t *tmp1124 = make_array<uint64_t>(1, 14, 14, 384);
  FusedBatchNorm4411(1, 14, 14, 384, tmp1120, tmp236, tmp237, 0, kScale, tmp1124);
  ClearMemSecret1(384, tmp236);
  ClearMemSecret1(384, tmp237);

  uint64_t *tmp1127 = make_array<uint64_t>(1, 14, 14, 384);
  Relu4(1, 14, 14, 384, tmp1124, tmp1127, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 384, tmp1124);

  uint64_t *tmp1132 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 384, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1127, tmp240, tmp241, tmp242, tmp1132);
  ClearMemSecret4(1, 1, 384, 128, tmp240);
  ClearMemSecret4(1, 14, 14, 384, tmp1127);
  ClearMemSecret1(128, tmp241);
  ClearMemSecret1(128, tmp242);

  uint64_t *tmp1136 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1132, tmp1136, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1132);

  uint64_t *tmp1138 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1136, tmp245,
                tmp1138);
  ClearMemSecret4(1, 14, 14, 128, tmp1136);
  ClearMemSecret4(3, 3, 128, 32, tmp245);

  int64_t tmp1141 = 3;

  uint64_t *tmp1142 = make_array<uint64_t>(1, 14, 14, 416);
  ScaleDown4(1, 14, 14, 32, tmp1138, kScale);
  Concat2T444(1, 14, 14, 416, 1, 14, 14, 384, tmp1120, 1, 14, 14, 32, tmp1138,
              tmp1141, tmp1142);
  ClearMemSecret4(1, 14, 14, 32, tmp1138);
  ClearMemSecret4(1, 14, 14, 384, tmp1120);
  ClearMemPublic(tmp1141);

  uint64_t *tmp1146 = make_array<uint64_t>(1, 14, 14, 416);
  FusedBatchNorm4411(1, 14, 14, 416, tmp1142, tmp246, tmp247, 0, kScale, tmp1146);
  ClearMemSecret1(416, tmp246);
  ClearMemSecret1(416, tmp247);

  uint64_t *tmp1149 = make_array<uint64_t>(1, 14, 14, 416);
  Relu4(1, 14, 14, 416, tmp1146, tmp1149, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 416, tmp1146);

  uint64_t *tmp1154 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 416, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1149, tmp250, tmp251, tmp252, tmp1154);
  ClearMemSecret4(1, 1, 416, 128, tmp250);
  ClearMemSecret4(1, 14, 14, 416, tmp1149);
  ClearMemSecret1(128, tmp251);
  ClearMemSecret1(128, tmp252);

  uint64_t *tmp1158 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1154, tmp1158, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1154);

  uint64_t *tmp1160 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1158, tmp255,
                tmp1160);
  ClearMemSecret4(1, 14, 14, 128, tmp1158);
  ClearMemSecret4(3, 3, 128, 32, tmp255);

  int64_t tmp1163 = 3;

  uint64_t *tmp1164 = make_array<uint64_t>(1, 14, 14, 448);
  ScaleDown4(1, 14, 14, 32, tmp1160, kScale);
  Concat2T444(1, 14, 14, 448, 1, 14, 14, 416, tmp1142, 1, 14, 14, 32, tmp1160,
              tmp1163, tmp1164);
  ClearMemSecret4(1, 14, 14, 32, tmp1160);
  ClearMemSecret4(1, 14, 14, 416, tmp1142);
  ClearMemPublic(tmp1163);

  uint64_t *tmp1168 = make_array<uint64_t>(1, 14, 14, 448);
  FusedBatchNorm4411(1, 14, 14, 448, tmp1164, tmp256, tmp257, 0, kScale, tmp1168);
  ClearMemSecret1(448, tmp256);
  ClearMemSecret1(448, tmp257);

  uint64_t *tmp1171 = make_array<uint64_t>(1, 14, 14, 448);
  Relu4(1, 14, 14, 448, tmp1168, tmp1171, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 448, tmp1168);

  uint64_t *tmp1176 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 448, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1171, tmp260, tmp261, tmp262, tmp1176);
  ClearMemSecret4(1, 1, 448, 128, tmp260);
  ClearMemSecret4(1, 14, 14, 448, tmp1171);
  ClearMemSecret1(128, tmp261);
  ClearMemSecret1(128, tmp262);

  uint64_t *tmp1180 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1176, tmp1180, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1176);

  uint64_t *tmp1182 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1180, tmp265,
                tmp1182);
  ClearMemSecret4(1, 14, 14, 128, tmp1180);
  ClearMemSecret4(3, 3, 128, 32, tmp265);

  int64_t tmp1185 = 3;

  uint64_t *tmp1186 = make_array<uint64_t>(1, 14, 14, 480);
  ScaleDown4(1, 14, 14, 32, tmp1182, kScale);
  Concat2T444(1, 14, 14, 480, 1, 14, 14, 448, tmp1164, 1, 14, 14, 32, tmp1182,
              tmp1185, tmp1186);
  ClearMemSecret4(1, 14, 14, 32, tmp1182);
  ClearMemSecret4(1, 14, 14, 448, tmp1164);
  ClearMemPublic(tmp1185);

  uint64_t *tmp1190 = make_array<uint64_t>(1, 14, 14, 480);
  FusedBatchNorm4411(1, 14, 14, 480, tmp1186, tmp266, tmp267, 0, kScale, tmp1190);
  ClearMemSecret1(480, tmp266);
  ClearMemSecret1(480, tmp267);

  uint64_t *tmp1193 = make_array<uint64_t>(1, 14, 14, 480);
  Relu4(1, 14, 14, 480, tmp1190, tmp1193, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 480, tmp1190);

  uint64_t *tmp1198 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 480, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1193, tmp270, tmp271, tmp272, tmp1198);
  ClearMemSecret4(1, 14, 14, 480, tmp1193);
  ClearMemSecret4(1, 1, 480, 128, tmp270);
  ClearMemSecret1(128, tmp271);
  ClearMemSecret1(128, tmp272);

  uint64_t *tmp1202 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1198, tmp1202, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1198);

  uint64_t *tmp1204 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1202, tmp275,
                tmp1204);
  ClearMemSecret4(3, 3, 128, 32, tmp275);
  ClearMemSecret4(1, 14, 14, 128, tmp1202);

  int64_t tmp1207 = 3;

  uint64_t *tmp1208 = make_array<uint64_t>(1, 14, 14, 512);
  ScaleDown4(1, 14, 14, 32, tmp1204, kScale);
  Concat2T444(1, 14, 14, 512, 1, 14, 14, 480, tmp1186, 1, 14, 14, 32, tmp1204,
              tmp1207, tmp1208);
  ClearMemPublic(tmp1207);
  ClearMemSecret4(1, 14, 14, 32, tmp1204);
  ClearMemSecret4(1, 14, 14, 480, tmp1186);

  uint64_t *tmp1212 = make_array<uint64_t>(1, 14, 14, 512);
  FusedBatchNorm4411(1, 14, 14, 512, tmp1208, tmp276, tmp277, 0, kScale, tmp1212);
  ClearMemSecret1(512, tmp277);
  ClearMemSecret1(512, tmp276);

  uint64_t *tmp1215 = make_array<uint64_t>(1, 14, 14, 512);
  Relu4(1, 14, 14, 512, tmp1212, tmp1215, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 512, tmp1212);

  uint64_t *tmp1220 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1215, tmp280, tmp281, tmp282, tmp1220);
  ClearMemSecret4(1, 1, 512, 128, tmp280);
  ClearMemSecret4(1, 14, 14, 512, tmp1215);
  ClearMemSecret1(128, tmp281);
  ClearMemSecret1(128, tmp282);

  uint64_t *tmp1224 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1220, tmp1224, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1220);

  uint64_t *tmp1226 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1224, tmp285,
                tmp1226);
  ClearMemSecret4(3, 3, 128, 32, tmp285);
  ClearMemSecret4(1, 14, 14, 128, tmp1224);

  int64_t tmp1229 = 3;

  uint64_t *tmp1230 = make_array<uint64_t>(1, 14, 14, 544);
  ScaleDown4(1, 14, 14, 32, tmp1226, kScale);
  Concat2T444(1, 14, 14, 544, 1, 14, 14, 512, tmp1208, 1, 14, 14, 32, tmp1226,
              tmp1229, tmp1230);
  ClearMemSecret4(1, 14, 14, 512, tmp1208);
  ClearMemPublic(tmp1229);
  ClearMemSecret4(1, 14, 14, 32, tmp1226);

  uint64_t *tmp1234 = make_array<uint64_t>(1, 14, 14, 544);
  FusedBatchNorm4411(1, 14, 14, 544, tmp1230, tmp286, tmp287, 0, kScale, tmp1234);
  ClearMemSecret1(544, tmp287);
  ClearMemSecret1(544, tmp286);

  uint64_t *tmp1237 = make_array<uint64_t>(1, 14, 14, 544);
  Relu4(1, 14, 14, 544, tmp1234, tmp1237, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 544, tmp1234);

  uint64_t *tmp1242 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 544, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1237, tmp290, tmp291, tmp292, tmp1242);
  ClearMemSecret4(1, 1, 544, 128, tmp290);
  ClearMemSecret4(1, 14, 14, 544, tmp1237);
  ClearMemSecret1(128, tmp291);
  ClearMemSecret1(128, tmp292);

  uint64_t *tmp1246 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1242, tmp1246, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1242);

  uint64_t *tmp1248 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1246, tmp295,
                tmp1248);
  ClearMemSecret4(3, 3, 128, 32, tmp295);
  ClearMemSecret4(1, 14, 14, 128, tmp1246);

  int64_t tmp1251 = 3;

  uint64_t *tmp1252 = make_array<uint64_t>(1, 14, 14, 576);
  ScaleDown4(1, 14, 14, 32, tmp1248, kScale);
  Concat2T444(1, 14, 14, 576, 1, 14, 14, 544, tmp1230, 1, 14, 14, 32, tmp1248,
              tmp1251, tmp1252);
  ClearMemSecret4(1, 14, 14, 544, tmp1230);
  ClearMemPublic(tmp1251);
  ClearMemSecret4(1, 14, 14, 32, tmp1248);

  uint64_t *tmp1256 = make_array<uint64_t>(1, 14, 14, 576);
  FusedBatchNorm4411(1, 14, 14, 576, tmp1252, tmp296, tmp297, 0, kScale, tmp1256);
  ClearMemSecret1(576, tmp296);
  ClearMemSecret1(576, tmp297);

  uint64_t *tmp1259 = make_array<uint64_t>(1, 14, 14, 576);
  Relu4(1, 14, 14, 576, tmp1256, tmp1259, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 576, tmp1256);

  uint64_t *tmp1264 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 576, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1259, tmp300, tmp301, tmp302, tmp1264);
  ClearMemSecret4(1, 1, 576, 128, tmp300);
  ClearMemSecret4(1, 14, 14, 576, tmp1259);
  ClearMemSecret1(128, tmp301);
  ClearMemSecret1(128, tmp302);

  uint64_t *tmp1268 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1264, tmp1268, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1264);

  uint64_t *tmp1270 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1268, tmp305,
                tmp1270);
  ClearMemSecret4(1, 14, 14, 128, tmp1268);
  ClearMemSecret4(3, 3, 128, 32, tmp305);

  int64_t tmp1273 = 3;

  uint64_t *tmp1274 = make_array<uint64_t>(1, 14, 14, 608);
  ScaleDown4(1, 14, 14, 32, tmp1270, kScale);
  Concat2T444(1, 14, 14, 608, 1, 14, 14, 576, tmp1252, 1, 14, 14, 32, tmp1270,
              tmp1273, tmp1274);
  ClearMemSecret4(1, 14, 14, 32, tmp1270);
  ClearMemPublic(tmp1273);
  ClearMemSecret4(1, 14, 14, 576, tmp1252);

  uint64_t *tmp1278 = make_array<uint64_t>(1, 14, 14, 608);
  FusedBatchNorm4411(1, 14, 14, 608, tmp1274, tmp306, tmp307, 0, kScale, tmp1278);
  ClearMemSecret1(608, tmp307);
  ClearMemSecret1(608, tmp306);

  uint64_t *tmp1281 = make_array<uint64_t>(1, 14, 14, 608);
  Relu4(1, 14, 14, 608, tmp1278, tmp1281, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 608, tmp1278);

  uint64_t *tmp1286 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 608, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1281, tmp310, tmp311, tmp312, tmp1286);
  ClearMemSecret4(1, 1, 608, 128, tmp310);
  ClearMemSecret4(1, 14, 14, 608, tmp1281);
  ClearMemSecret1(128, tmp311);
  ClearMemSecret1(128, tmp312);

  uint64_t *tmp1290 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1286, tmp1290, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1286);

  uint64_t *tmp1292 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1290, tmp315,
                tmp1292);
  ClearMemSecret4(1, 14, 14, 128, tmp1290);
  ClearMemSecret4(3, 3, 128, 32, tmp315);

  int64_t tmp1295 = 3;

  uint64_t *tmp1296 = make_array<uint64_t>(1, 14, 14, 640);
  ScaleDown4(1, 14, 14, 32, tmp1292, kScale);
  Concat2T444(1, 14, 14, 640, 1, 14, 14, 608, tmp1274, 1, 14, 14, 32, tmp1292,
              tmp1295, tmp1296);
  ClearMemSecret4(1, 14, 14, 32, tmp1292);
  ClearMemSecret4(1, 14, 14, 608, tmp1274);
  ClearMemPublic(tmp1295);

  uint64_t *tmp1300 = make_array<uint64_t>(1, 14, 14, 640);
  FusedBatchNorm4411(1, 14, 14, 640, tmp1296, tmp316, tmp317, 0, kScale, tmp1300);
  ClearMemSecret1(640, tmp316);
  ClearMemSecret1(640, tmp317);

  uint64_t *tmp1303 = make_array<uint64_t>(1, 14, 14, 640);
  Relu4(1, 14, 14, 640, tmp1300, tmp1303, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 640, tmp1300);

  uint64_t *tmp1308 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 640, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1303, tmp320, tmp321, tmp322, tmp1308);
  ClearMemSecret4(1, 14, 14, 640, tmp1303);
  ClearMemSecret4(1, 1, 640, 128, tmp320);
  ClearMemSecret1(128, tmp321);
  ClearMemSecret1(128, tmp322);

  uint64_t *tmp1312 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1308, tmp1312, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1308);

  uint64_t *tmp1314 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1312, tmp325,
                tmp1314);
  ClearMemSecret4(1, 14, 14, 128, tmp1312);
  ClearMemSecret4(3, 3, 128, 32, tmp325);

  int64_t tmp1317 = 3;

  uint64_t *tmp1318 = make_array<uint64_t>(1, 14, 14, 672);
  ScaleDown4(1, 14, 14, 32, tmp1314, kScale);
  Concat2T444(1, 14, 14, 672, 1, 14, 14, 640, tmp1296, 1, 14, 14, 32, tmp1314,
              tmp1317, tmp1318);
  ClearMemSecret4(1, 14, 14, 640, tmp1296);
  ClearMemPublic(tmp1317);
  ClearMemSecret4(1, 14, 14, 32, tmp1314);

  uint64_t *tmp1322 = make_array<uint64_t>(1, 14, 14, 672);
  FusedBatchNorm4411(1, 14, 14, 672, tmp1318, tmp326, tmp327, 0, kScale, tmp1322);
  ClearMemSecret1(672, tmp327);
  ClearMemSecret1(672, tmp326);

  uint64_t *tmp1325 = make_array<uint64_t>(1, 14, 14, 672);
  Relu4(1, 14, 14, 672, tmp1322, tmp1325, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 672, tmp1322);

  uint64_t *tmp1330 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 672, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1325, tmp330, tmp331, tmp332, tmp1330);
  ClearMemSecret4(1, 14, 14, 672, tmp1325);
  ClearMemSecret4(1, 1, 672, 128, tmp330);
  ClearMemSecret1(128, tmp331);
  ClearMemSecret1(128, tmp332);

  uint64_t *tmp1334 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1330, tmp1334, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1330);

  uint64_t *tmp1336 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1334, tmp335,
                tmp1336);
  ClearMemSecret4(3, 3, 128, 32, tmp335);
  ClearMemSecret4(1, 14, 14, 128, tmp1334);

  int64_t tmp1339 = 3;

  uint64_t *tmp1340 = make_array<uint64_t>(1, 14, 14, 704);
  ScaleDown4(1, 14, 14, 32, tmp1336, kScale);
  Concat2T444(1, 14, 14, 704, 1, 14, 14, 672, tmp1318, 1, 14, 14, 32, tmp1336,
              tmp1339, tmp1340);
  ClearMemSecret4(1, 14, 14, 672, tmp1318);
  ClearMemPublic(tmp1339);
  ClearMemSecret4(1, 14, 14, 32, tmp1336);

  uint64_t *tmp1344 = make_array<uint64_t>(1, 14, 14, 704);
  FusedBatchNorm4411(1, 14, 14, 704, tmp1340, tmp336, tmp337, 0, kScale, tmp1344);
  ClearMemSecret1(704, tmp337);
  ClearMemSecret1(704, tmp336);

  uint64_t *tmp1347 = make_array<uint64_t>(1, 14, 14, 704);
  Relu4(1, 14, 14, 704, tmp1344, tmp1347, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 704, tmp1344);

  uint64_t *tmp1352 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 704, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1347, tmp340, tmp341, tmp342, tmp1352);
  ClearMemSecret4(1, 1, 704, 128, tmp340);
  ClearMemSecret4(1, 14, 14, 704, tmp1347);
  ClearMemSecret1(128, tmp341);
  ClearMemSecret1(128, tmp342);

  uint64_t *tmp1356 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1352, tmp1356, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1352);

  uint64_t *tmp1358 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1356, tmp345,
                tmp1358);
  ClearMemSecret4(1, 14, 14, 128, tmp1356);
  ClearMemSecret4(3, 3, 128, 32, tmp345);

  int64_t tmp1361 = 3;

  uint64_t *tmp1362 = make_array<uint64_t>(1, 14, 14, 736);
  ScaleDown4(1, 14, 14, 32, tmp1358, kScale);
  Concat2T444(1, 14, 14, 736, 1, 14, 14, 704, tmp1340, 1, 14, 14, 32, tmp1358,
              tmp1361, tmp1362);
  ClearMemSecret4(1, 14, 14, 32, tmp1358);
  ClearMemSecret4(1, 14, 14, 704, tmp1340);
  ClearMemPublic(tmp1361);

  uint64_t *tmp1366 = make_array<uint64_t>(1, 14, 14, 736);
  FusedBatchNorm4411(1, 14, 14, 736, tmp1362, tmp346, tmp347, 0, kScale, tmp1366);
  ClearMemSecret1(736, tmp347);
  ClearMemSecret1(736, tmp346);

  uint64_t *tmp1369 = make_array<uint64_t>(1, 14, 14, 736);
  Relu4(1, 14, 14, 736, tmp1366, tmp1369, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 736, tmp1366);

  uint64_t *tmp1374 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 736, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1369, tmp350, tmp351, tmp352, tmp1374);
  ClearMemSecret4(1, 1, 736, 128, tmp350);
  ClearMemSecret4(1, 14, 14, 736, tmp1369);
  ClearMemSecret1(128, tmp351);
  ClearMemSecret1(128, tmp352);

  uint64_t *tmp1378 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1374, tmp1378, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1374);

  uint64_t *tmp1380 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1378, tmp355,
                tmp1380);
  ClearMemSecret4(3, 3, 128, 32, tmp355);
  ClearMemSecret4(1, 14, 14, 128, tmp1378);

  int64_t tmp1383 = 3;

  uint64_t *tmp1384 = make_array<uint64_t>(1, 14, 14, 768);
  ScaleDown4(1, 14, 14, 32, tmp1380, kScale);
  Concat2T444(1, 14, 14, 768, 1, 14, 14, 736, tmp1362, 1, 14, 14, 32, tmp1380,
              tmp1383, tmp1384);
  ClearMemPublic(tmp1383);
  ClearMemSecret4(1, 14, 14, 736, tmp1362);
  ClearMemSecret4(1, 14, 14, 32, tmp1380);

  uint64_t *tmp1388 = make_array<uint64_t>(1, 14, 14, 768);
  FusedBatchNorm4411(1, 14, 14, 768, tmp1384, tmp356, tmp357, 0, kScale, tmp1388);
  ClearMemSecret1(768, tmp356);
  ClearMemSecret1(768, tmp357);

  uint64_t *tmp1391 = make_array<uint64_t>(1, 14, 14, 768);
  Relu4(1, 14, 14, 768, tmp1388, tmp1391, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 768, tmp1388);

  uint64_t *tmp1396 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 768, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1391, tmp360, tmp361, tmp362, tmp1396);
  ClearMemSecret4(1, 1, 768, 128, tmp360);
  ClearMemSecret4(1, 14, 14, 768, tmp1391);
  ClearMemSecret1(128, tmp361);
  ClearMemSecret1(128, tmp362);

  uint64_t *tmp1400 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1396, tmp1400, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1396);

  uint64_t *tmp1402 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1400, tmp365,
                tmp1402);
  ClearMemSecret4(3, 3, 128, 32, tmp365);
  ClearMemSecret4(1, 14, 14, 128, tmp1400);

  int64_t tmp1405 = 3;

  uint64_t *tmp1406 = make_array<uint64_t>(1, 14, 14, 800);
  ScaleDown4(1, 14, 14, 32, tmp1402, kScale);
  Concat2T444(1, 14, 14, 800, 1, 14, 14, 768, tmp1384, 1, 14, 14, 32, tmp1402,
              tmp1405, tmp1406);
  ClearMemSecret4(1, 14, 14, 768, tmp1384);
  ClearMemPublic(tmp1405);
  ClearMemSecret4(1, 14, 14, 32, tmp1402);

  uint64_t *tmp1410 = make_array<uint64_t>(1, 14, 14, 800);
  FusedBatchNorm4411(1, 14, 14, 800, tmp1406, tmp366, tmp367, 0, kScale, tmp1410);
  ClearMemSecret1(800, tmp367);
  ClearMemSecret1(800, tmp366);

  uint64_t *tmp1413 = make_array<uint64_t>(1, 14, 14, 800);
  Relu4(1, 14, 14, 800, tmp1410, tmp1413, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 800, tmp1410);

  uint64_t *tmp1418 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 800, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1413, tmp370, tmp371, tmp372, tmp1418);
  ClearMemSecret4(1, 1, 800, 128, tmp370);
  ClearMemSecret4(1, 14, 14, 800, tmp1413);
  ClearMemSecret1(128, tmp371);
  ClearMemSecret1(128, tmp372);

  uint64_t *tmp1422 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1418, tmp1422, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1418);

  uint64_t *tmp1424 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1422, tmp375,
                tmp1424);
  ClearMemSecret4(1, 14, 14, 128, tmp1422);
  ClearMemSecret4(3, 3, 128, 32, tmp375);

  int64_t tmp1427 = 3;

  uint64_t *tmp1428 = make_array<uint64_t>(1, 14, 14, 832);
  ScaleDown4(1, 14, 14, 32, tmp1424, kScale);
  Concat2T444(1, 14, 14, 832, 1, 14, 14, 800, tmp1406, 1, 14, 14, 32, tmp1424,
              tmp1427, tmp1428);
  ClearMemPublic(tmp1427);
  ClearMemSecret4(1, 14, 14, 32, tmp1424);
  ClearMemSecret4(1, 14, 14, 800, tmp1406);

  uint64_t *tmp1432 = make_array<uint64_t>(1, 14, 14, 832);
  FusedBatchNorm4411(1, 14, 14, 832, tmp1428, tmp376, tmp377, 0, kScale, tmp1432);
  ClearMemSecret1(832, tmp376);
  ClearMemSecret1(832, tmp377);

  uint64_t *tmp1435 = make_array<uint64_t>(1, 14, 14, 832);
  Relu4(1, 14, 14, 832, tmp1432, tmp1435, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 832, tmp1432);

  uint64_t *tmp1440 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 832, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1435, tmp380, tmp381, tmp382, tmp1440);
  ClearMemSecret4(1, 14, 14, 832, tmp1435);
  ClearMemSecret4(1, 1, 832, 128, tmp380);
  ClearMemSecret1(128, tmp381);
  ClearMemSecret1(128, tmp382);

  uint64_t *tmp1444 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1440, tmp1444, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1440);

  uint64_t *tmp1446 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1444, tmp385,
                tmp1446);
  ClearMemSecret4(3, 3, 128, 32, tmp385);
  ClearMemSecret4(1, 14, 14, 128, tmp1444);

  int64_t tmp1449 = 3;

  uint64_t *tmp1450 = make_array<uint64_t>(1, 14, 14, 864);
  ScaleDown4(1, 14, 14, 32, tmp1446, kScale);
  Concat2T444(1, 14, 14, 864, 1, 14, 14, 832, tmp1428, 1, 14, 14, 32, tmp1446,
              tmp1449, tmp1450);
  ClearMemSecret4(1, 14, 14, 32, tmp1446);
  ClearMemPublic(tmp1449);
  ClearMemSecret4(1, 14, 14, 832, tmp1428);

  uint64_t *tmp1454 = make_array<uint64_t>(1, 14, 14, 864);
  FusedBatchNorm4411(1, 14, 14, 864, tmp1450, tmp386, tmp387, 0, kScale, tmp1454);
  ClearMemSecret1(864, tmp387);
  ClearMemSecret1(864, tmp386);

  uint64_t *tmp1457 = make_array<uint64_t>(1, 14, 14, 864);
  Relu4(1, 14, 14, 864, tmp1454, tmp1457, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 864, tmp1454);

  uint64_t *tmp1462 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 864, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1457, tmp390, tmp391, tmp392, tmp1462);
  ClearMemSecret4(1, 1, 864, 128, tmp390);
  ClearMemSecret4(1, 14, 14, 864, tmp1457);
  ClearMemSecret1(128, tmp391);
  ClearMemSecret1(128, tmp392);

  uint64_t *tmp1466 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1462, tmp1466, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1462);

  uint64_t *tmp1468 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1466, tmp395,
                tmp1468);
  ClearMemSecret4(3, 3, 128, 32, tmp395);
  ClearMemSecret4(1, 14, 14, 128, tmp1466);

  int64_t tmp1471 = 3;

  uint64_t *tmp1472 = make_array<uint64_t>(1, 14, 14, 896);
  ScaleDown4(1, 14, 14, 32, tmp1468, kScale);
  Concat2T444(1, 14, 14, 896, 1, 14, 14, 864, tmp1450, 1, 14, 14, 32, tmp1468,
              tmp1471, tmp1472);
  ClearMemSecret4(1, 14, 14, 32, tmp1468);
  ClearMemSecret4(1, 14, 14, 864, tmp1450);
  ClearMemPublic(tmp1471);

  uint64_t *tmp1476 = make_array<uint64_t>(1, 14, 14, 896);
  FusedBatchNorm4411(1, 14, 14, 896, tmp1472, tmp396, tmp397, 0, kScale, tmp1476);
  ClearMemSecret1(896, tmp397);
  ClearMemSecret1(896, tmp396);

  uint64_t *tmp1479 = make_array<uint64_t>(1, 14, 14, 896);
  Relu4(1, 14, 14, 896, tmp1476, tmp1479, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 896, tmp1476);

  uint64_t *tmp1484 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 896, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1479, tmp400, tmp401, tmp402, tmp1484);
  ClearMemSecret4(1, 1, 896, 128, tmp400);
  ClearMemSecret4(1, 14, 14, 896, tmp1479);
  ClearMemSecret1(128, tmp401);
  ClearMemSecret1(128, tmp402);

  uint64_t *tmp1488 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1484, tmp1488, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1484);

  uint64_t *tmp1490 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1488, tmp405,
                tmp1490);
  ClearMemSecret4(3, 3, 128, 32, tmp405);
  ClearMemSecret4(1, 14, 14, 128, tmp1488);

  int64_t tmp1493 = 3;

  uint64_t *tmp1494 = make_array<uint64_t>(1, 14, 14, 928);
  ScaleDown4(1, 14, 14, 32, tmp1490, kScale);
  Concat2T444(1, 14, 14, 928, 1, 14, 14, 896, tmp1472, 1, 14, 14, 32, tmp1490,
              tmp1493, tmp1494);
  ClearMemSecret4(1, 14, 14, 896, tmp1472);
  ClearMemPublic(tmp1493);
  ClearMemSecret4(1, 14, 14, 32, tmp1490);

  uint64_t *tmp1498 = make_array<uint64_t>(1, 14, 14, 928);
  FusedBatchNorm4411(1, 14, 14, 928, tmp1494, tmp406, tmp407, 0, kScale, tmp1498);
  ClearMemSecret1(928, tmp407);
  ClearMemSecret1(928, tmp406);

  uint64_t *tmp1501 = make_array<uint64_t>(1, 14, 14, 928);
  Relu4(1, 14, 14, 928, tmp1498, tmp1501, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 928, tmp1498);

  uint64_t *tmp1506 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 928, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1501, tmp410, tmp411, tmp412, tmp1506);
  ClearMemSecret4(1, 14, 14, 928, tmp1501);
  ClearMemSecret4(1, 1, 928, 128, tmp410);
  ClearMemSecret1(128, tmp411);
  ClearMemSecret1(128, tmp412);

  uint64_t *tmp1510 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1506, tmp1510, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1506);

  uint64_t *tmp1512 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1510, tmp415,
                tmp1512);
  ClearMemSecret4(3, 3, 128, 32, tmp415);
  ClearMemSecret4(1, 14, 14, 128, tmp1510);

  int64_t tmp1515 = 3;

  uint64_t *tmp1516 = make_array<uint64_t>(1, 14, 14, 960);
  ScaleDown4(1, 14, 14, 32, tmp1512, kScale);
  Concat2T444(1, 14, 14, 960, 1, 14, 14, 928, tmp1494, 1, 14, 14, 32, tmp1512,
              tmp1515, tmp1516);
  ClearMemSecret4(1, 14, 14, 32, tmp1512);
  ClearMemPublic(tmp1515);
  ClearMemSecret4(1, 14, 14, 928, tmp1494);

  uint64_t *tmp1520 = make_array<uint64_t>(1, 14, 14, 960);
  FusedBatchNorm4411(1, 14, 14, 960, tmp1516, tmp416, tmp417, 0, kScale, tmp1520);
  ClearMemSecret1(960, tmp416);
  ClearMemSecret1(960, tmp417);

  uint64_t *tmp1523 = make_array<uint64_t>(1, 14, 14, 960);
  Relu4(1, 14, 14, 960, tmp1520, tmp1523, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 960, tmp1520);

  uint64_t *tmp1528 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 960, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1523, tmp420, tmp421, tmp422, tmp1528);
  ClearMemSecret4(1, 1, 960, 128, tmp420);
  ClearMemSecret4(1, 14, 14, 960, tmp1523);
  ClearMemSecret1(128, tmp421);
  ClearMemSecret1(128, tmp422);

  uint64_t *tmp1532 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1528, tmp1532, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1528);

  uint64_t *tmp1534 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1532, tmp425,
                tmp1534);
  ClearMemSecret4(1, 14, 14, 128, tmp1532);
  ClearMemSecret4(3, 3, 128, 32, tmp425);

  int64_t tmp1537 = 3;

  uint64_t *tmp1538 = make_array<uint64_t>(1, 14, 14, 992);
  ScaleDown4(1, 14, 14, 32, tmp1534, kScale);
  Concat2T444(1, 14, 14, 992, 1, 14, 14, 960, tmp1516, 1, 14, 14, 32, tmp1534,
              tmp1537, tmp1538);
  ClearMemSecret4(1, 14, 14, 32, tmp1534);
  ClearMemPublic(tmp1537);
  ClearMemSecret4(1, 14, 14, 960, tmp1516);

  uint64_t *tmp1542 = make_array<uint64_t>(1, 14, 14, 992);
  FusedBatchNorm4411(1, 14, 14, 992, tmp1538, tmp426, tmp427, 0, kScale, tmp1542);
  ClearMemSecret1(992, tmp427);
  ClearMemSecret1(992, tmp426);

  uint64_t *tmp1545 = make_array<uint64_t>(1, 14, 14, 992);
  Relu4(1, 14, 14, 992, tmp1542, tmp1545, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 992, tmp1542);

  uint64_t *tmp1550 = make_array<uint64_t>(1, 14, 14, 128);
  FusedBN(1, 14, 14, 992, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1545, tmp430, tmp431, tmp432, tmp1550);
  ClearMemSecret4(1, 14, 14, 992, tmp1545);
  ClearMemSecret4(1, 1, 992, 128, tmp430);
  ClearMemSecret1(128, tmp431);
  ClearMemSecret1(128, tmp432);

  uint64_t *tmp1554 = make_array<uint64_t>(1, 14, 14, 128);
  Relu4(1, 14, 14, 128, tmp1550, tmp1554, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 128, tmp1550);

  uint64_t *tmp1556 = make_array<uint64_t>(1, 14, 14, 32);
  Conv2DWrapper_seperate(1, 14, 14, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1554, tmp435,
                tmp1556);
  ClearMemSecret4(1, 14, 14, 128, tmp1554);
  ClearMemSecret4(3, 3, 128, 32, tmp435);

  int64_t tmp1559 = 3;

  uint64_t *tmp1560 = make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 32, tmp1556, kScale);
  Concat2T444(1, 14, 14, 1024, 1, 14, 14, 992, tmp1538, 1, 14, 14, 32, tmp1556,
              tmp1559, tmp1560);
  ClearMemSecret4(1, 14, 14, 32, tmp1556);
  ClearMemSecret4(1, 14, 14, 992, tmp1538);
  ClearMemPublic(tmp1559);

  uint64_t *tmp1564 = make_array<uint64_t>(1, 14, 14, 1024);
  FusedBatchNorm4411(1, 14, 14, 1024, tmp1560, tmp436, tmp437, 0, kScale, tmp1564);
  ClearMemSecret1(1024, tmp437);
  ClearMemSecret4(1, 14, 14, 1024, tmp1560);
  ClearMemSecret1(1024, tmp436);

  uint64_t *tmp1568 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp1564, tmp1568, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 1024, tmp1564);

  uint64_t *tmp1570 = make_array<uint64_t>(1, 14, 14, 512);
  Conv2DWrapper_seperate(1, 14, 14, 1024, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp1568, tmp440,
                tmp1570);
  ClearMemSecret4(1, 14, 14, 1024, tmp1568);
  ClearMemSecret4(1, 1, 1024, 512, tmp440);

  uint64_t *tmp1573 = make_array<uint64_t>(1, 7, 7, 512);
  AvgPool(1, 7, 7, 512, 2, 2, 0, 0, 0, 0, 2, 2, 1, 14, 14, 512, tmp1570,
          tmp1573);
  ClearMemSecret4(1, 14, 14, 512, tmp1570);

  uint64_t *tmp1575 = make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp1573, kScale);
  FusedBatchNorm4411(1, 7, 7, 512, tmp1573, tmp441, tmp442, 0, kScale, tmp1575);
  ClearMemSecret1(512, tmp442);
  ClearMemSecret1(512, tmp441);

  uint64_t *tmp1578 = make_array<uint64_t>(1, 7, 7, 512);
  Relu4(1, 7, 7, 512, tmp1575, tmp1578, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 512, tmp1575);

  uint64_t *tmp1583 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1578, tmp445, tmp446, tmp447, tmp1583);
  ClearMemSecret4(1, 1, 512, 128, tmp445);
  ClearMemSecret4(1, 7, 7, 512, tmp1578);
  ClearMemSecret1(128, tmp446);
  ClearMemSecret1(128, tmp447);

  uint64_t *tmp1587 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1583, tmp1587, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1583);

  uint64_t *tmp1589 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1587, tmp450,
                tmp1589);
  ClearMemSecret4(1, 7, 7, 128, tmp1587);
  ClearMemSecret4(3, 3, 128, 32, tmp450);

  int64_t tmp1592 = 3;

  uint64_t *tmp1593 = make_array<uint64_t>(1, 7, 7, 544);
  ScaleDown4(1, 7, 7, 32, tmp1589, kScale);
  Concat2T444(1, 7, 7, 544, 1, 7, 7, 512, tmp1573, 1, 7, 7, 32, tmp1589,
              tmp1592, tmp1593);
  ClearMemSecret4(1, 7, 7, 512, tmp1573);
  ClearMemSecret4(1, 7, 7, 32, tmp1589);
  ClearMemPublic(tmp1592);

  uint64_t *tmp1597 = make_array<uint64_t>(1, 7, 7, 544);
  FusedBatchNorm4411(1, 7, 7, 544, tmp1593, tmp451, tmp452, 0, kScale, tmp1597);
  ClearMemSecret1(544, tmp452);
  ClearMemSecret1(544, tmp451);

  uint64_t *tmp1600 = make_array<uint64_t>(1, 7, 7, 544);
  Relu4(1, 7, 7, 544, tmp1597, tmp1600, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 544, tmp1597);

  uint64_t *tmp1605 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 544, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1600, tmp455, tmp456, tmp457, tmp1605);
  ClearMemSecret4(1, 7, 7, 544, tmp1600);
  ClearMemSecret4(1, 1, 544, 128, tmp455);
  ClearMemSecret1(128, tmp456);
  ClearMemSecret1(128, tmp457);

  uint64_t *tmp1609 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1605, tmp1609, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1605);

  uint64_t *tmp1611 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1609, tmp460,
                tmp1611);
  ClearMemSecret4(1, 7, 7, 128, tmp1609);
  ClearMemSecret4(3, 3, 128, 32, tmp460);

  int64_t tmp1614 = 3;

  uint64_t *tmp1615 = make_array<uint64_t>(1, 7, 7, 576);
  ScaleDown4(1, 7, 7, 32, tmp1611, kScale);
  Concat2T444(1, 7, 7, 576, 1, 7, 7, 544, tmp1593, 1, 7, 7, 32, tmp1611,
              tmp1614, tmp1615);
  ClearMemSecret4(1, 7, 7, 32, tmp1611);
  ClearMemPublic(tmp1614);
  ClearMemSecret4(1, 7, 7, 544, tmp1593);

  uint64_t *tmp1619 = make_array<uint64_t>(1, 7, 7, 576);
  FusedBatchNorm4411(1, 7, 7, 576, tmp1615, tmp461, tmp462, 0, kScale, tmp1619);
  ClearMemSecret1(576, tmp461);
  ClearMemSecret1(576, tmp462);

  uint64_t *tmp1622 = make_array<uint64_t>(1, 7, 7, 576);
  Relu4(1, 7, 7, 576, tmp1619, tmp1622, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 576, tmp1619);

  uint64_t *tmp1627 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 576, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1622, tmp465, tmp466, tmp467, tmp1627);
  ClearMemSecret4(1, 7, 7, 576, tmp1622);
  ClearMemSecret4(1, 1, 576, 128, tmp465);
  ClearMemSecret1(128, tmp466);
  ClearMemSecret1(128, tmp467);

  uint64_t *tmp1631 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1627, tmp1631, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1627);

  uint64_t *tmp1633 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1631, tmp470,
                tmp1633);
  ClearMemSecret4(1, 7, 7, 128, tmp1631);
  ClearMemSecret4(3, 3, 128, 32, tmp470);

  int64_t tmp1636 = 3;

  uint64_t *tmp1637 = make_array<uint64_t>(1, 7, 7, 608);
  ScaleDown4(1, 7, 7, 32, tmp1633, kScale);
  Concat2T444(1, 7, 7, 608, 1, 7, 7, 576, tmp1615, 1, 7, 7, 32, tmp1633,
              tmp1636, tmp1637);
  ClearMemSecret4(1, 7, 7, 576, tmp1615);
  ClearMemPublic(tmp1636);
  ClearMemSecret4(1, 7, 7, 32, tmp1633);

  uint64_t *tmp1641 = make_array<uint64_t>(1, 7, 7, 608);
  FusedBatchNorm4411(1, 7, 7, 608, tmp1637, tmp471, tmp472, 0, kScale, tmp1641);
  ClearMemSecret1(608, tmp471);
  ClearMemSecret1(608, tmp472);

  uint64_t *tmp1644 = make_array<uint64_t>(1, 7, 7, 608);
  Relu4(1, 7, 7, 608, tmp1641, tmp1644, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 608, tmp1641);

  uint64_t *tmp1649 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 608, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1644, tmp475, tmp476, tmp477, tmp1649);
  ClearMemSecret4(1, 7, 7, 608, tmp1644);
  ClearMemSecret4(1, 1, 608, 128, tmp475);
  ClearMemSecret1(128, tmp476);
  ClearMemSecret1(128, tmp477);

  uint64_t *tmp1653 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1649, tmp1653, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1649);

  uint64_t *tmp1655 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1653, tmp480,
                tmp1655);
  ClearMemSecret4(1, 7, 7, 128, tmp1653);
  ClearMemSecret4(3, 3, 128, 32, tmp480);

  int64_t tmp1658 = 3;

  uint64_t *tmp1659 = make_array<uint64_t>(1, 7, 7, 640);
  ScaleDown4(1, 7, 7, 32, tmp1655, kScale);
  Concat2T444(1, 7, 7, 640, 1, 7, 7, 608, tmp1637, 1, 7, 7, 32, tmp1655,
              tmp1658, tmp1659);
  ClearMemSecret4(1, 7, 7, 32, tmp1655);
  ClearMemPublic(tmp1658);
  ClearMemSecret4(1, 7, 7, 608, tmp1637);

  uint64_t *tmp1663 = make_array<uint64_t>(1, 7, 7, 640);
  FusedBatchNorm4411(1, 7, 7, 640, tmp1659, tmp481, tmp482, 0, kScale, tmp1663);
  ClearMemSecret1(640, tmp481);
  ClearMemSecret1(640, tmp482);

  uint64_t *tmp1666 = make_array<uint64_t>(1, 7, 7, 640);
  Relu4(1, 7, 7, 640, tmp1663, tmp1666, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 640, tmp1663);

  uint64_t *tmp1671 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 640, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1666, tmp485, tmp486, tmp487, tmp1671);
  ClearMemSecret4(1, 7, 7, 640, tmp1666);
  ClearMemSecret4(1, 1, 640, 128, tmp485);
  ClearMemSecret1(128, tmp486);
  ClearMemSecret1(128, tmp487);

  uint64_t *tmp1675 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1671, tmp1675, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1671);

  uint64_t *tmp1677 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1675, tmp490,
                tmp1677);
  ClearMemSecret4(3, 3, 128, 32, tmp490);
  ClearMemSecret4(1, 7, 7, 128, tmp1675);

  int64_t tmp1680 = 3;

  uint64_t *tmp1681 = make_array<uint64_t>(1, 7, 7, 672);
  ScaleDown4(1, 7, 7, 32, tmp1677, kScale);
  Concat2T444(1, 7, 7, 672, 1, 7, 7, 640, tmp1659, 1, 7, 7, 32, tmp1677,
              tmp1680, tmp1681);
  ClearMemSecret4(1, 7, 7, 32, tmp1677);
  ClearMemPublic(tmp1680);
  ClearMemSecret4(1, 7, 7, 640, tmp1659);

  uint64_t *tmp1685 = make_array<uint64_t>(1, 7, 7, 672);
  FusedBatchNorm4411(1, 7, 7, 672, tmp1681, tmp491, tmp492, 0, kScale, tmp1685);
  ClearMemSecret1(672, tmp492);
  ClearMemSecret1(672, tmp491);

  uint64_t *tmp1688 = make_array<uint64_t>(1, 7, 7, 672);
  Relu4(1, 7, 7, 672, tmp1685, tmp1688, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 672, tmp1685);

  uint64_t *tmp1693 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 672, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1688, tmp495, tmp496, tmp497, tmp1693);
  ClearMemSecret4(1, 1, 672, 128, tmp495);
  ClearMemSecret4(1, 7, 7, 672, tmp1688);
  ClearMemSecret1(128, tmp496);
  ClearMemSecret1(128, tmp497);

  uint64_t *tmp1697 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1693, tmp1697, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1693);

  uint64_t *tmp1699 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1697, tmp500,
                tmp1699);
  ClearMemSecret4(3, 3, 128, 32, tmp500);
  ClearMemSecret4(1, 7, 7, 128, tmp1697);

  int64_t tmp1702 = 3;

  uint64_t *tmp1703 = make_array<uint64_t>(1, 7, 7, 704);
  ScaleDown4(1, 7, 7, 32, tmp1699, kScale);
  Concat2T444(1, 7, 7, 704, 1, 7, 7, 672, tmp1681, 1, 7, 7, 32, tmp1699,
              tmp1702, tmp1703);
  ClearMemSecret4(1, 7, 7, 672, tmp1681);
  ClearMemSecret4(1, 7, 7, 32, tmp1699);
  ClearMemPublic(tmp1702);

  uint64_t *tmp1707 = make_array<uint64_t>(1, 7, 7, 704);
  FusedBatchNorm4411(1, 7, 7, 704, tmp1703, tmp501, tmp502, 0, kScale, tmp1707);
  ClearMemSecret1(704, tmp502);
  ClearMemSecret1(704, tmp501);

  uint64_t *tmp1710 = make_array<uint64_t>(1, 7, 7, 704);
  Relu4(1, 7, 7, 704, tmp1707, tmp1710, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 704, tmp1707);

  uint64_t *tmp1715 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 704, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1710, tmp505, tmp506, tmp507, tmp1715);
  ClearMemSecret4(1, 7, 7, 704, tmp1710);
  ClearMemSecret4(1, 1, 704, 128, tmp505);
  ClearMemSecret1(128, tmp506);
  ClearMemSecret1(128, tmp507);

  uint64_t *tmp1719 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1715, tmp1719, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1715);

  uint64_t *tmp1721 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1719, tmp510,
                tmp1721);
  ClearMemSecret4(1, 7, 7, 128, tmp1719);
  ClearMemSecret4(3, 3, 128, 32, tmp510);

  int64_t tmp1724 = 3;

  uint64_t *tmp1725 = make_array<uint64_t>(1, 7, 7, 736);
  ScaleDown4(1, 7, 7, 32, tmp1721, kScale);
  Concat2T444(1, 7, 7, 736, 1, 7, 7, 704, tmp1703, 1, 7, 7, 32, tmp1721,
              tmp1724, tmp1725);
  ClearMemPublic(tmp1724);
  ClearMemSecret4(1, 7, 7, 704, tmp1703);
  ClearMemSecret4(1, 7, 7, 32, tmp1721);

  uint64_t *tmp1729 = make_array<uint64_t>(1, 7, 7, 736);
  FusedBatchNorm4411(1, 7, 7, 736, tmp1725, tmp511, tmp512, 0, kScale, tmp1729);
  ClearMemSecret1(736, tmp511);
  ClearMemSecret1(736, tmp512);

  uint64_t *tmp1732 = make_array<uint64_t>(1, 7, 7, 736);
  Relu4(1, 7, 7, 736, tmp1729, tmp1732, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 736, tmp1729);

  uint64_t *tmp1737 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 736, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1732, tmp515, tmp516, tmp517, tmp1737);
  ClearMemSecret4(1, 1, 736, 128, tmp515);
  ClearMemSecret4(1, 7, 7, 736, tmp1732);
  ClearMemSecret1(128, tmp516);
  ClearMemSecret1(128, tmp517);

  uint64_t *tmp1741 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1737, tmp1741, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1737);

  uint64_t *tmp1743 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1741, tmp520,
                tmp1743);
  ClearMemSecret4(3, 3, 128, 32, tmp520);
  ClearMemSecret4(1, 7, 7, 128, tmp1741);

  int64_t tmp1746 = 3;

  uint64_t *tmp1747 = make_array<uint64_t>(1, 7, 7, 768);
  ScaleDown4(1, 7, 7, 32, tmp1743, kScale);
  Concat2T444(1, 7, 7, 768, 1, 7, 7, 736, tmp1725, 1, 7, 7, 32, tmp1743,
              tmp1746, tmp1747);
  ClearMemPublic(tmp1746);
  ClearMemSecret4(1, 7, 7, 736, tmp1725);
  ClearMemSecret4(1, 7, 7, 32, tmp1743);

  uint64_t *tmp1751 = make_array<uint64_t>(1, 7, 7, 768);
  FusedBatchNorm4411(1, 7, 7, 768, tmp1747, tmp521, tmp522, 0, kScale, tmp1751);
  ClearMemSecret1(768, tmp522);
  ClearMemSecret1(768, tmp521);

  uint64_t *tmp1754 = make_array<uint64_t>(1, 7, 7, 768);
  Relu4(1, 7, 7, 768, tmp1751, tmp1754, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 768, tmp1751);

  uint64_t *tmp1759 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 768, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1754, tmp525, tmp526, tmp527, tmp1759);
  ClearMemSecret4(1, 7, 7, 768, tmp1754);
  ClearMemSecret4(1, 1, 768, 128, tmp525);
  ClearMemSecret1(128, tmp526);
  ClearMemSecret1(128, tmp527);

  uint64_t *tmp1763 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1759, tmp1763, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1759);

  uint64_t *tmp1765 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1763, tmp530,
                tmp1765);
  ClearMemSecret4(3, 3, 128, 32, tmp530);
  ClearMemSecret4(1, 7, 7, 128, tmp1763);

  int64_t tmp1768 = 3;

  uint64_t *tmp1769 = make_array<uint64_t>(1, 7, 7, 800);
  ScaleDown4(1, 7, 7, 32, tmp1765, kScale);
  Concat2T444(1, 7, 7, 800, 1, 7, 7, 768, tmp1747, 1, 7, 7, 32, tmp1765,
              tmp1768, tmp1769);
  ClearMemSecret4(1, 7, 7, 768, tmp1747);
  ClearMemSecret4(1, 7, 7, 32, tmp1765);
  ClearMemPublic(tmp1768);

  uint64_t *tmp1773 = make_array<uint64_t>(1, 7, 7, 800);
  FusedBatchNorm4411(1, 7, 7, 800, tmp1769, tmp531, tmp532, 0, kScale, tmp1773);
  ClearMemSecret1(800, tmp531);
  ClearMemSecret1(800, tmp532);

  uint64_t *tmp1776 = make_array<uint64_t>(1, 7, 7, 800);
  Relu4(1, 7, 7, 800, tmp1773, tmp1776, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 800, tmp1773);

  uint64_t *tmp1781 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 800, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1776, tmp535, tmp536, tmp537, tmp1781);
  ClearMemSecret4(1, 7, 7, 800, tmp1776);
  ClearMemSecret4(1, 1, 800, 128, tmp535);
  ClearMemSecret1(128, tmp536);
  ClearMemSecret1(128, tmp537);

  uint64_t *tmp1785 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1781, tmp1785, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1781);

  uint64_t *tmp1787 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1785, tmp540,
                tmp1787);
  ClearMemSecret4(1, 7, 7, 128, tmp1785);
  ClearMemSecret4(3, 3, 128, 32, tmp540);

  int64_t tmp1790 = 3;

  uint64_t *tmp1791 = make_array<uint64_t>(1, 7, 7, 832);
  ScaleDown4(1, 7, 7, 32, tmp1787, kScale);
  Concat2T444(1, 7, 7, 832, 1, 7, 7, 800, tmp1769, 1, 7, 7, 32, tmp1787,
              tmp1790, tmp1791);
  ClearMemSecret4(1, 7, 7, 800, tmp1769);
  ClearMemSecret4(1, 7, 7, 32, tmp1787);
  ClearMemPublic(tmp1790);

  uint64_t *tmp1795 = make_array<uint64_t>(1, 7, 7, 832);
  FusedBatchNorm4411(1, 7, 7, 832, tmp1791, tmp541, tmp542, 0, kScale, tmp1795);
  ClearMemSecret1(832, tmp541);
  ClearMemSecret1(832, tmp542);

  uint64_t *tmp1798 = make_array<uint64_t>(1, 7, 7, 832);
  Relu4(1, 7, 7, 832, tmp1795, tmp1798, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 832, tmp1795);

  uint64_t *tmp1803 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 832, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1798, tmp545, tmp546, tmp547, tmp1803);
  ClearMemSecret4(1, 1, 832, 128, tmp545);
  ClearMemSecret4(1, 7, 7, 832, tmp1798);
  ClearMemSecret1(128, tmp546);
  ClearMemSecret1(128, tmp547);

  uint64_t *tmp1807 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1803, tmp1807, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1803);

  uint64_t *tmp1809 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1807, tmp550,
                tmp1809);
  ClearMemSecret4(3, 3, 128, 32, tmp550);
  ClearMemSecret4(1, 7, 7, 128, tmp1807);

  int64_t tmp1812 = 3;

  uint64_t *tmp1813 = make_array<uint64_t>(1, 7, 7, 864);
  ScaleDown4(1, 7, 7, 32, tmp1809, kScale);
  Concat2T444(1, 7, 7, 864, 1, 7, 7, 832, tmp1791, 1, 7, 7, 32, tmp1809,
              tmp1812, tmp1813);
  ClearMemSecret4(1, 7, 7, 832, tmp1791);
  ClearMemPublic(tmp1812);
  ClearMemSecret4(1, 7, 7, 32, tmp1809);

  uint64_t *tmp1817 = make_array<uint64_t>(1, 7, 7, 864);
  FusedBatchNorm4411(1, 7, 7, 864, tmp1813, tmp551, tmp552, 0, kScale, tmp1817);
  ClearMemSecret1(864, tmp551);
  ClearMemSecret1(864, tmp552);

  uint64_t *tmp1820 = make_array<uint64_t>(1, 7, 7, 864);
  Relu4(1, 7, 7, 864, tmp1817, tmp1820, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 864, tmp1817);

  uint64_t *tmp1825 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 864, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1820, tmp555, tmp556, tmp557, tmp1825);
  ClearMemSecret4(1, 1, 864, 128, tmp555);
  ClearMemSecret4(1, 7, 7, 864, tmp1820);
  ClearMemSecret1(128, tmp556);
  ClearMemSecret1(128, tmp557);

  uint64_t *tmp1829 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1825, tmp1829, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1825);

  uint64_t *tmp1831 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1829, tmp560,
                tmp1831);
  ClearMemSecret4(1, 7, 7, 128, tmp1829);
  ClearMemSecret4(3, 3, 128, 32, tmp560);

  int64_t tmp1834 = 3;

  uint64_t *tmp1835 = make_array<uint64_t>(1, 7, 7, 896);
  ScaleDown4(1, 7, 7, 32, tmp1831, kScale);
  Concat2T444(1, 7, 7, 896, 1, 7, 7, 864, tmp1813, 1, 7, 7, 32, tmp1831,
              tmp1834, tmp1835);
  ClearMemSecret4(1, 7, 7, 32, tmp1831);
  ClearMemSecret4(1, 7, 7, 864, tmp1813);
  ClearMemPublic(tmp1834);

  uint64_t *tmp1839 = make_array<uint64_t>(1, 7, 7, 896);
  FusedBatchNorm4411(1, 7, 7, 896, tmp1835, tmp561, tmp562, 0, kScale, tmp1839);
  ClearMemSecret1(896, tmp561);
  ClearMemSecret1(896, tmp562);

  uint64_t *tmp1842 = make_array<uint64_t>(1, 7, 7, 896);
  Relu4(1, 7, 7, 896, tmp1839, tmp1842, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 896, tmp1839);

  uint64_t *tmp1847 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 896, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1842, tmp565, tmp566, tmp567, tmp1847);
  ClearMemSecret4(1, 1, 896, 128, tmp565);
  ClearMemSecret4(1, 7, 7, 896, tmp1842);
  ClearMemSecret1(128, tmp566);
  ClearMemSecret1(128, tmp567);

  uint64_t *tmp1851 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1847, tmp1851, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1847);

  uint64_t *tmp1853 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1851, tmp570,
                tmp1853);
  ClearMemSecret4(1, 7, 7, 128, tmp1851);
  ClearMemSecret4(3, 3, 128, 32, tmp570);

  int64_t tmp1856 = 3;

  uint64_t *tmp1857 = make_array<uint64_t>(1, 7, 7, 928);
  ScaleDown4(1, 7, 7, 32, tmp1853, kScale);
  Concat2T444(1, 7, 7, 928, 1, 7, 7, 896, tmp1835, 1, 7, 7, 32, tmp1853,
              tmp1856, tmp1857);
  ClearMemSecret4(1, 7, 7, 896, tmp1835);
  ClearMemPublic(tmp1856);
  ClearMemSecret4(1, 7, 7, 32, tmp1853);

  uint64_t *tmp1861 = make_array<uint64_t>(1, 7, 7, 928);
  FusedBatchNorm4411(1, 7, 7, 928, tmp1857, tmp571, tmp572, 0, kScale, tmp1861);
  ClearMemSecret1(928, tmp571);
  ClearMemSecret1(928, tmp572);

  uint64_t *tmp1864 = make_array<uint64_t>(1, 7, 7, 928);
  Relu4(1, 7, 7, 928, tmp1861, tmp1864, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 928, tmp1861);

  uint64_t *tmp1869 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 928, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1864, tmp575, tmp576, tmp577, tmp1869);
  ClearMemSecret4(1, 1, 928, 128, tmp575);
  ClearMemSecret4(1, 7, 7, 928, tmp1864);
  ClearMemSecret1(128, tmp576);
  ClearMemSecret1(128, tmp577);

  uint64_t *tmp1873 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1869, tmp1873, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1869);

  uint64_t *tmp1875 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1873, tmp580,
                tmp1875);
  ClearMemSecret4(3, 3, 128, 32, tmp580);
  ClearMemSecret4(1, 7, 7, 128, tmp1873);

  int64_t tmp1878 = 3;

  uint64_t *tmp1879 = make_array<uint64_t>(1, 7, 7, 960);
  ScaleDown4(1, 7, 7, 32, tmp1875, kScale);
  Concat2T444(1, 7, 7, 960, 1, 7, 7, 928, tmp1857, 1, 7, 7, 32, tmp1875,
              tmp1878, tmp1879);
  ClearMemSecret4(1, 7, 7, 928, tmp1857);
  ClearMemPublic(tmp1878);
  ClearMemSecret4(1, 7, 7, 32, tmp1875);

  uint64_t *tmp1883 = make_array<uint64_t>(1, 7, 7, 960);
  FusedBatchNorm4411(1, 7, 7, 960, tmp1879, tmp581, tmp582, 0, kScale, tmp1883);
  ClearMemSecret1(960, tmp581);
  ClearMemSecret1(960, tmp582);

  uint64_t *tmp1886 = make_array<uint64_t>(1, 7, 7, 960);
  Relu4(1, 7, 7, 960, tmp1883, tmp1886, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 960, tmp1883);

  uint64_t *tmp1891 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 960, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1886, tmp585, tmp586, tmp587, tmp1891);
  ClearMemSecret4(1, 7, 7, 960, tmp1886);
  ClearMemSecret4(1, 1, 960, 128, tmp585);
  ClearMemSecret1(128, tmp586);
  ClearMemSecret1(128, tmp587);

  uint64_t *tmp1895 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1891, tmp1895, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1891);

  uint64_t *tmp1897 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1895, tmp590,
                tmp1897);
  ClearMemSecret4(1, 7, 7, 128, tmp1895);
  ClearMemSecret4(3, 3, 128, 32, tmp590);

  int64_t tmp1900 = 3;

  uint64_t *tmp1901 = make_array<uint64_t>(1, 7, 7, 992);
  ScaleDown4(1, 7, 7, 32, tmp1897, kScale);
  Concat2T444(1, 7, 7, 992, 1, 7, 7, 960, tmp1879, 1, 7, 7, 32, tmp1897,
              tmp1900, tmp1901);
  ClearMemSecret4(1, 7, 7, 32, tmp1897);
  ClearMemPublic(tmp1900);
  ClearMemSecret4(1, 7, 7, 960, tmp1879);

  uint64_t *tmp1905 = make_array<uint64_t>(1, 7, 7, 992);
  FusedBatchNorm4411(1, 7, 7, 992, tmp1901, tmp591, tmp592, 0, kScale, tmp1905);
  ClearMemSecret1(992, tmp592);
  ClearMemSecret1(992, tmp591);

  uint64_t *tmp1908 = make_array<uint64_t>(1, 7, 7, 992);
  Relu4(1, 7, 7, 992, tmp1905, tmp1908, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 992, tmp1905);

  uint64_t *tmp1913 = make_array<uint64_t>(1, 7, 7, 128);
  FusedBN(1, 7, 7, 992, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp1908, tmp595, tmp596, tmp597, tmp1913);
  ClearMemSecret4(1, 7, 7, 992, tmp1908);
  ClearMemSecret4(1, 1, 992, 128, tmp595);
  ClearMemSecret1(128, tmp596);
  ClearMemSecret1(128, tmp597);

  uint64_t *tmp1917 = make_array<uint64_t>(1, 7, 7, 128);
  Relu4(1, 7, 7, 128, tmp1913, tmp1917, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 128, tmp1913);

  uint64_t *tmp1919 = make_array<uint64_t>(1, 7, 7, 32);
  Conv2DWrapper_seperate(1, 7, 7, 128, 3, 3, 32, 1, 1, 1, 1, 1, 1, tmp1917, tmp600,
                tmp1919);
  ClearMemSecret4(3, 3, 128, 32, tmp600);
  ClearMemSecret4(1, 7, 7, 128, tmp1917);

  int64_t tmp1922 = 3;

  uint64_t *tmp1923 = make_array<uint64_t>(1, 7, 7, 1024);
  ScaleDown4(1, 7, 7, 32, tmp1919, kScale);
  Concat2T444(1, 7, 7, 1024, 1, 7, 7, 992, tmp1901, 1, 7, 7, 32, tmp1919,
              tmp1922, tmp1923);
  ClearMemSecret4(1, 7, 7, 32, tmp1919);
  ClearMemPublic(tmp1922);
  ClearMemSecret4(1, 7, 7, 992, tmp1901);

  uint64_t *tmp1927 = make_array<uint64_t>(1, 7, 7, 1024);
  FusedBatchNorm4411(1, 7, 7, 1024, tmp1923, tmp601, tmp602, 0, kScale, tmp1927);
  ClearMemSecret4(1, 7, 7, 1024, tmp1923);
  ClearMemSecret1(1024, tmp602);
  ClearMemSecret1(1024, tmp601);

  uint64_t *tmp1931 = make_array<uint64_t>(1, 7, 7, 1024);
  Relu4(1, 7, 7, 1024, tmp1927, tmp1931, kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 1024, tmp1927);

  uint64_t *tmp1933 = make_array<uint64_t>(1, 1, 1, 1024);
  AvgPool(1, 1, 1, 1024, 7, 7, 0, 0, 0, 0, 1, 1, 1, 7, 7, 1024, tmp1931,
          tmp1933);
  ClearMemSecret4(1, 7, 7, 1024, tmp1931);

  uint64_t *tmp1935 = make_array<uint64_t>(1, 1, 1, 1000);
  Conv2DWrapper_seperate(1, 1, 1, 1024, 1, 1, 1000, 0, 0, 0, 0, 1, 1, tmp1933, tmp605,
                tmp1935);
  ClearMemSecret4(1, 1, 1, 1024, tmp1933);
  ClearMemSecret4(1, 1, 1024, 1000, tmp605);

  uint64_t *tmp1938 = make_array<uint64_t>(1, 1, 1, 1000);
  ScaleUp1(1000, tmp606, kScale);
  MatAddBroadCast4(1, 1, 1, 1000, tmp1935, tmp606, tmp1938);
  ClearMemSecret1(1000, tmp606);
  ClearMemSecret4(1, 1, 1, 1000, tmp1935);
  ...
  for (uint64_t i0 = 0; i0 < 1001; i0++) {
	prediction_vector[i0] = funcReconstruct2PCCons(Arr1DIdxRowM(tmp1938, 1001, i0), 2) / 
	  std::pow(4., kScale);
  }
  ClearMemSecret4(1, 1, 1, 1000, tmp1938);
  if (party == CLIENT) {
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 1; i0++) {
    for (uint64_t i1 = (uint64_t)0; i1 < 1; i1++) {
      for (uint64_t i2 = (uint64_t)0; i2 < 1; i2++) {
